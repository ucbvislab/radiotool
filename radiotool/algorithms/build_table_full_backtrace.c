/* Generated by Cython 0.20.1 on Thu Apr 10 20:10:10 2014 */
...
static char __pyx_k_max_beats_with_padding[] = "max_beats_with_padding";
...
static PyObject *__pyx_n_s_max_beats_with_padding;
 ...
 * 
 */
  __pyx_t_5 = ((__pyx_v_global_start_l == ((__pyx_v_pen.shape[1]) - 1)) != 0);
  if (__pyx_t_5) {
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "radiotool/algorithms/build_table_full_backtrace.pyx":46
 * 
 *     for i in range(p.max_beats_with_padding):
 *         for j in range(p.p0):             # <<<<<<<<<<<<<<
 *             new_pen[i * p.n_beats + j] = pen[j, column]
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":47
 *     for i in range(p.max_beats_with_padding):
 *         for j in range(p.p0):
 *             new_pen[i * p.n_beats + j] = pen[j, column]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":54
 *     #--- CONSTRAINTS ---#
 *     # * don't start song in segment beat other than first
 *     if global_start_l == 0:             # <<<<<<<<<<<<<<
 ...
 *             new_pen[i] += p.pen_val
 */
  __pyx_t_9 = ((__pyx_v_global_start_l == ((__pyx_v_pen.shape[1]) - 1)) != 0);
  if (__pyx_t_9) {
 ...
 */
    ...
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":61
 *     if global_start_l == pen.shape[1] - 1:
 *         for i in range(p.n_beats * p.min_beats):
 *             new_pen[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":74
 * 
 *     cdef double *full_cost = <double *>malloc(p.all_full * pen.shape[1] * sizeof(double))
 *     cdef int *prev_node = <int *>malloc(p.all_full * pen.shape[1] * sizeof(int))             # <<<<<<<<<<<<<<
 * 
...

{
    ...
    /* "radiotool/algorithms/build_table_full_backtrace.pyx":84
 *     if end_beat != -1:
 *         cost[:] = 99999999  # N.inf
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  __pyx_t_4 = (__pyx_v_cost.shape[0]);
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":96
 *     # optimize
 ...
 * 
 */
  for (__pyx_t_5 = ((__pyx_v_pen.shape[1]) - 2); __pyx_t_5 > -1; __pyx_t_5-=1) {
    __pyx_v_l = __pyx_t_5;
 ...
 */
    __pyx_t_7 = (__pyx_v_p.n_beats * (__pyx_v_p.min_beats - 1));
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":104
 *         for idx in range(p.n_beats * (p.min_beats - 1)):
 *             beat_seg_i = idx / p.n_beats
 *             orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "radiotool/algorithms/build_table_full_backtrace.pyx":109
 *             for j in range(p.n_song_starts):
 *                 if song_starts[j] <= orig_beat_i < song_ends[j]:
 *                     song_i = j             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
      ...
      __pyx_t_14 = __pyx_v_song_i;
      for (__pyx_t_15 = (*((int *) ( /* dim=0 */ (__pyx_v_song_starts.data + __pyx_t_14 * __pyx_v_song_starts.strides[0]) ))); __pyx_t_15 < __pyx_t_10; __pyx_t_15+=1) {
 ...
 */
        __pyx_t_13 = ((__pyx_v_minval == -1.0) != 0);
        if (!__pyx_t_13) {
 ...
 *             orig_beat_i = idx % p.n_beats
 */
    __pyx_t_7 = (__pyx_v_p.n_beats * (__pyx_v_p.max_beats - 1));
    for (__pyx_t_8 = (__pyx_v_p.n_beats * (__pyx_v_p.min_beats - 1)); __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_idx = __pyx_t_8;
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":130
 *         for idx in range(p.n_beats * (p.min_beats - 1), p.n_beats * (p.max_beats - 1)):
 *             beat_seg_i = idx / p.n_beats
 *             orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_19 = ((*((int *) ( /* dim=0 */ (__pyx_v_song_starts.data + __pyx_t_21 * __pyx_v_song_starts.strides[0]) ))) <= __pyx_v_orig_beat_i);
        if (__pyx_t_19) {
          __pyx_t_22 = __pyx_v_j;
          __pyx_t_19 = (__pyx_v_orig_beat_i < (*((int *) ( /* dim=0 */ (__pyx_v_song_ends.data + __pyx_t_22 * __pyx_v_song_ends.strides[0]) ))));
        }
 ...
 */
          ...
          /* "radiotool/algorithms/build_table_full_backtrace.pyx":136
 *                 if song_starts[j] <= orig_beat_i < song_ends[j]:
 *                     song_i = j
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_20 = (*((int *) ( /* dim=0 */ (__pyx_v_song_ends.data + __pyx_t_15 * __pyx_v_song_ends.strides[0]) )));
      __pyx_t_23 = __pyx_v_song_i;
      for (__pyx_t_24 = (*((int *) ( /* dim=0 */ (__pyx_v_song_starts.data + __pyx_t_23 * __pyx_v_song_starts.strides[0]) ))); __pyx_t_24 < __pyx_t_20; __pyx_t_24+=1) {
 ...
 */
        __pyx_t_13 = ((__pyx_v_minval == -1.0) != 0);
        if (!__pyx_t_13) {
          __pyx_t_19 = ((__pyx_v_tmpval < __pyx_v_minval) != 0);
 ...
 *                 minval = tmpval
 */
      __pyx_t_20 = __pyx_v_orig_beat_i;
      __pyx_t_24 = __pyx_v_p.p0;
      __pyx_t_28 = __pyx_v_idx;
      __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_20 * __pyx_v_tc.strides[0]) ) + __pyx_t_24 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_28 * __pyx_v_pen_val.strides[0]) )))) + (__pyx_v_full_cost[((__pyx_v_p.p0_full * __pyx_v_rowlen) + (__pyx_v_l + 1))]));
 ...
 */
      ...
      if (!__pyx_t_1) {
        __pyx_t_13 = ((__pyx_v_tmpval < __pyx_v_minval) != 0);
        __pyx_t_19 = __pyx_t_13;
      } else {
        __pyx_t_19 = __pyx_t_1;
      }
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":153
 *                 min_idx = p.p0_full
 * 
 *             min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_t_8 = (__pyx_v_p.n_beats * __pyx_v_p.max_beats);
    for (__pyx_t_30 = (__pyx_v_p.n_beats * (__pyx_v_p.max_beats - 1)); __pyx_t_30 < __pyx_t_8; __pyx_t_30+=1) {
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_full_backtrace.pyx":163
 * 
 *             # must be going to first pause beat
 ...
 * 
 */
    __pyx_t_7 = (__pyx_v_p.all_full - 1);
    for (__pyx_t_8 = __pyx_v_p.p0_full; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_idx = __pyx_t_8;
 ...
 */
      ...
      for (__pyx_t_38 = 0; __pyx_t_38 < __pyx_t_30; __pyx_t_38+=1) {
        __pyx_v_j = __pyx_t_38;

        /* "radiotool/algorithms/build_table_full_backtrace.pyx":175
 *             minval = -1
 *             for j in range(p.n_pauses):
 *                 tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + full_cost[(p.p0_full + j) * rowlen + (l + 1)]             # <<<<<<<<<<<<<<
 *                 if minval == -1 or tmpval < minval:
 ...
 */
        ...
        __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_39 * __pyx_v_tc.strides[0]) ) + __pyx_t_40 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_41 * __pyx_v_pen_val.strides[0]) )))) + (__pyx_v_full_cost[(((__pyx_v_p.p0_full + __pyx_v_j) * __pyx_v_rowlen) + (__pyx_v_l + 1))]));

        /* "radiotool/algorithms/build_table_full_backtrace.pyx":176
 *             for j in range(p.n_pauses):
 *                 tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + full_cost[(p.p0_full + j) * rowlen + (l + 1)]
 *                 if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                     minval = tmpval
 *                     min_idx = p.p0_full + j
 */
        __pyx_t_19 = ((__pyx_v_minval == -1.0) != 0);
        if (!__pyx_t_19) {
          __pyx_t_1 = ((__pyx_v_tmpval < __pyx_v_minval) != 0);
 ...
 *             if minval == -1 or tmpval < minval:
 */
    __pyx_t_8 = __pyx_v_p.n_beats;
    for (__pyx_t_38 = 0; __pyx_t_38 < __pyx_t_8; __pyx_t_38+=1) {
      __pyx_v_j = __pyx_t_38;
 ...
 *                 minval = tmpval
 */
      __pyx_t_7 = ((__pyx_v_p.p0 + __pyx_v_p.n_pauses) - 1);
      __pyx_t_42 = __pyx_v_j;
      __pyx_t_43 = (__pyx_v_p.all_full - 1);
      __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_7 * __pyx_v_tc.strides[0]) ) + __pyx_t_42 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_43 * __pyx_v_pen_val.strides[0]) )))) + (__pyx_v_full_cost[((__pyx_v_j * __pyx_v_rowlen) + (__pyx_v_l + 1))]));
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_full_backtrace.pyx":190
 *             if minval == -1 or tmpval < minval:
 *                 minval = tmpval
 *                 min_idx = j             # <<<<<<<<<<<<<<
 *         min_vals[p.all_full - 1] = minval
 ...
 */
    __pyx_t_1 = ((__pyx_v_minval == -1.0) != 0);
    if (!__pyx_t_1) {
      __pyx_t_13 = (((__pyx_v_full_cost[((__pyx_v_i * __pyx_v_rowlen) + 0)]) < __pyx_v_minval) != 0);
      __pyx_t_19 = __pyx_t_13;
    } else {
      __pyx_t_19 = __pyx_t_1;
    }
 ...
 */
  __pyx_t_4 = 0;
  *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_4 * __pyx_v_global_path.strides[0]) )) = __pyx_v_min_idx;
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":210
 * 
 *     cdef double total_cost_remaining = minval
 *     cdef int node = min_idx             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_45 = ((__pyx_v_pen.shape[1]) - 1);
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_45; __pyx_t_5+=1) {
    __pyx_v_l = __pyx_t_5;
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_full_backtrace.pyx":214
 *     for l in range(pen.shape[1] - 1):
 *         node = prev_node[node * rowlen + l]
 *         global_path[l + 1] = node             # <<<<<<<<<<<<<<
 *         global_path_cost[l] = total_cost_remaining - full_cost[node * rowlen + (l + 1)]
 ...
 */
    __pyx_t_46 = (__pyx_v_l + 1);
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_46 * __pyx_v_global_path.strides[0]) )) = __pyx_v_node;
 ...
 */
    __pyx_t_8 = __pyx_v_l;
    *((double *) ( /* dim=0 */ (__pyx_v_global_path_cost.data + __pyx_t_8 * __pyx_v_global_path_cost.strides[0]) )) = (__pyx_v_total_cost_remaining - (__pyx_v_full_cost[((__pyx_v_node * __pyx_v_rowlen) + (__pyx_v_l + 1))]));
 ...
 */
    ...
    __pyx_v_total_cost_remaining = (__pyx_v_total_cost_remaining - (*((double *) ( /* dim=0 */ (__pyx_v_global_path_cost.data + __pyx_t_38 * __pyx_v_global_path_cost.strides[0]) ))));
  }
 ...
 */
  __pyx_t_45 = ((__pyx_v_pen.shape[1]) - 1);
  *((double *) ( /* dim=0 */ (__pyx_v_global_path_cost.data + __pyx_t_45 * __pyx_v_global_path_cost.strides[0]) )) = __pyx_v_total_cost_remaining;
...
static PyObject *__pyx_pw_9radiotool_10algorithms_26build_table_full_backtrace_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("build_table (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_penalty)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 4, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_song_starts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 4, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_song_ends)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 4, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "build_table") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_trans_cost = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_trans_cost.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_penalty = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_penalty.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_song_starts = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2]); if (unlikely(!__pyx_v_song_starts.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 226; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_song_ends = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3]); if (unlikely(!__pyx_v_song_ends.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 226; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[4]) {
      __pyx_v_min_beats = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_min_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_min_beats = ((int)-1);
    }
    if (values[5]) {
      __pyx_v_max_beats = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_max_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_max_beats = ((int)-1);
    }
    if (values[6]) {
      __pyx_v_first_pause = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_first_pause == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("build_table", 0, 4, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/build_table_full_backtrace.pyx":236
 *     elif max_beats != -1:
 *         # 4? One measures of padding? Just a thought
 *         max_beats_with_padding = max_beats             # <<<<<<<<<<<<<<
 *     elif min_beats != -1:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":252
 *     p.min_beats = min_beats
 *     p.max_beats = max_beats
 *     p.max_beats_with_padding = max_beats_with_padding             # <<<<<<<<<<<<<<
 *     p.p0_full = p.n_beats * p.max_beats_with_padding
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_full_backtrace.pyx":255
 *     p.p0_full = p.n_beats * p.max_beats_with_padding
 *     p.all_full = p.p0_full + p.n_pauses
 *     p.n_song_starts = len(song_starts)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_song_starts, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 255; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = PyObject_Length(__pyx_t_5); if (unlikely(__pyx_t_6 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 255; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_p.n_song_starts = __pyx_t_6;
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 258; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 261; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 262; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *     mv1 = array1
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 263; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array3 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":264
 *     array2 = clone(dtemplate, p.all_full, False)
 *     array3 = clone(dtemplate, p.all_full, False)
 *     array4 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     mv1 = array1
 *     mv2 = array2
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *     mv4 = array4
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_array2));
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 266; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv2 = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":267
 *     mv1 = array1
 *     mv2 = array2
 *     mv3 = array3             # <<<<<<<<<<<<<<
 *     mv4 = array4
 * 
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_array3));
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 267; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv3 = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":268
 *     mv2 = array2
 *     mv3 = array3
 *     mv4 = array4             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_array4));
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 268; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv4 = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":270
 *     mv4 = array4
 * 
 *     array5 = clone(dtemplate, penalty.shape[1], False)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, (__pyx_v_penalty.shape[1]), 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 270; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_array5));
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 271; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_global_path_cost = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":273
 *     global_path_cost = array5
 * 
 *     cdef array ar, template = array('i')             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 * 
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template, (__pyx_v_penalty.shape[1]), 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_ar = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_full_backtrace.pyx":275
 *     cdef array ar, template = array('i')
 *     ar = clone(template, penalty.shape[1], False)
 *     cdef int[:] global_path = ar             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_v_ar));
  if (unlikely(!__pyx_t_8.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_global_path = __pyx_t_8;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_global_path, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  if (PyList_CheckExact(__pyx_t_9) || PyTuple_CheckExact(__pyx_t_9)) {
    __pyx_t_10 = __pyx_t_9; __Pyx_INCREF(__pyx_t_10); __pyx_t_6 = 0;
    __pyx_t_11 = NULL;
  } else {
    __pyx_t_6 = -1; __pyx_t_10 = PyObject_GetIter(__pyx_t_9); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  for (;;) {
    if (!__pyx_t_11 && PyList_CheckExact(__pyx_t_10)) {
      ...
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_9 = PyList_GET_ITEM(__pyx_t_10, __pyx_t_6); __Pyx_INCREF(__pyx_t_9); __pyx_t_6++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_9 = PySequence_ITEM(__pyx_t_10, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else if (!__pyx_t_11 && PyTuple_CheckExact(__pyx_t_10)) {
      if (__pyx_t_6 >= PyTuple_GET_SIZE(__pyx_t_10)) break;
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_9 = PyTuple_GET_ITEM(__pyx_t_10, __pyx_t_6); __Pyx_INCREF(__pyx_t_9); __pyx_t_6++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_9 = PySequence_ITEM(__pyx_t_10, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else {
    ...
    __pyx_t_9 = 0;
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_5, (PyObject*)__pyx_v_x))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __pyx_t_10 = PyList_New(0); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_global_path_cost, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  if (PyList_CheckExact(__pyx_t_9) || PyTuple_CheckExact(__pyx_t_9)) {
    __pyx_t_12 = __pyx_t_9; __Pyx_INCREF(__pyx_t_12); __pyx_t_6 = 0;
    __pyx_t_11 = NULL;
  } else {
    __pyx_t_6 = -1; __pyx_t_12 = PyObject_GetIter(__pyx_t_9); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  for (;;) {
    if (!__pyx_t_11 && PyList_CheckExact(__pyx_t_12)) {
      ...
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_9 = PyList_GET_ITEM(__pyx_t_12, __pyx_t_6); __Pyx_INCREF(__pyx_t_9); __pyx_t_6++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_9 = PySequence_ITEM(__pyx_t_12, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else if (!__pyx_t_11 && PyTuple_CheckExact(__pyx_t_12)) {
      if (__pyx_t_6 >= PyTuple_GET_SIZE(__pyx_t_12)) break;
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_9 = PyTuple_GET_ITEM(__pyx_t_12, __pyx_t_6); __Pyx_INCREF(__pyx_t_9); __pyx_t_6++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_9 = PySequence_ITEM(__pyx_t_12, __pyx_t_6); __pyx_t_6++; if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else {
    ...
    __Pyx_XDECREF_SET(__pyx_v_x, __pyx_t_9);
    __pyx_t_9 = 0;
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_10, (PyObject*)__pyx_v_x))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 285; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_max_beats_with_padding, __pyx_k_max_beats_with_padding, sizeof(__pyx_k_max_beats_with_padding), 0, 0, 1, 1},
 ...
 *     cdef double[:] mv1, mv2, mv3, mv4, global_path_cost
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_d); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 258; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef int[:] global_path = ar
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     int min_beats=-1, int max_beats=-1, int first_pause=-1):
 */
  __pyx_tuple__16 = PyTuple_Pack(25, __pyx_n_s_trans_cost, __pyx_n_s_penalty, __pyx_n_s_song_starts, __pyx_n_s_song_ends, __pyx_n_s_min_beats, __pyx_n_s_max_beats, __pyx_n_s_first_pause, __pyx_n_s_max_beats_with_padding, __pyx_n_s_i, __pyx_n_s_p, __pyx_n_s_dtemplate, __pyx_n_s_array1, __pyx_n_s_array2, __pyx_n_s_array3, __pyx_n_s_array4, __pyx_n_s_array5, __pyx_n_s_mv1, __pyx_n_s_mv2, __pyx_n_s_mv3, __pyx_n_s_mv4, __pyx_n_s_global_path_cost, __pyx_n_s_ar, __pyx_n_s_template, __pyx_n_s_global_path, __pyx_n_s_x); if (unlikely(!__pyx_tuple__16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__16);
  __Pyx_GIVEREF(__pyx_tuple__16);
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(7, 0, 25, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_srubin_code_radiotool_rad, __pyx_n_s_build_table, 225, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     int min_beats=-1, int max_beats=-1, int first_pause=-1):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9radiotool_10algorithms_26build_table_full_backtrace_1build_table, NULL, __pyx_n_s_radiotool_algorithms_build_table); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_build_table, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
