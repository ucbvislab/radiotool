/* Generated by Cython 0.20.1 on Wed Mar 19 15:41:12 2014 */
...
static char __pyx_k_finding_minimum[] = "finding minimum";
static char __pyx_k_backwrd_end_beat[] = "backwrd. end   beat:";
static char __pyx_k_pyx_releasebuffer[] = "__pyx_releasebuffer";
static char __pyx_k_forward_start_beat[] = "forward. start beat:";
...
static PyObject *__pyx_kp_s_backwrd_end_beat;
 ...
 * 
 */
    __pyx_t_12 = __Pyx_PyInt_From_long((__pyx_v_offset + 1)); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_opt_i); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_14 = PyTuple_New(2); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_12 = 0;
    __pyx_t_13 = 0;
    __pyx_t_13 = __Pyx_PyString_Format(__pyx_kp_s_setting_time_d_to_d, __pyx_t_14); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_13) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_offset); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 393; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_14 = __Pyx_PyInt_From_int(__pyx_v_opt_i); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 393; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_14);
    ...
    __pyx_t_13 = 0;
    __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyString_Format(__pyx_kp_s_setting_time_d_to_d_2, __pyx_t_12); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 393; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_14) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 393; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
 ...
 * 
 */
    __pyx_t_14 = __Pyx_PyInt_From_int(__pyx_v_start_beat); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_offset); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_22 = -1;
...
__pyx_t_13 = PyInt_FromSsize_t((__pyx_t_21.shape[1])); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __PYX_XDEC_MEMVIEW(&__pyx_t_21, 1);
    __pyx_t_23 = PyTuple_New(6); if (unlikely(!__pyx_t_23)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_INCREF(__pyx_kp_s_forward_start_beat);
    PyTuple_SET_ITEM(__pyx_t_23, 0, __pyx_kp_s_forward_start_beat);
    __Pyx_GIVEREF(__pyx_kp_s_forward_start_beat);
    PyTuple_SET_ITEM(__pyx_t_23, 1, __pyx_t_14);
    __Pyx_GIVEREF(__pyx_t_14);
    __Pyx_INCREF(__pyx_kp_s_offset);
    PyTuple_SET_ITEM(__pyx_t_23, 2, __pyx_kp_s_offset);
    __Pyx_GIVEREF(__pyx_kp_s_offset);
    PyTuple_SET_ITEM(__pyx_t_23, 3, __pyx_t_12);
    __Pyx_GIVEREF(__pyx_t_12);
    __Pyx_INCREF(__pyx_kp_s_length);
    PyTuple_SET_ITEM(__pyx_t_23, 4, __pyx_kp_s_length);
    __Pyx_GIVEREF(__pyx_kp_s_length);
    PyTuple_SET_ITEM(__pyx_t_23, 5, __pyx_t_13);
    __Pyx_GIVEREF(__pyx_t_13);
    __pyx_t_14 = 0;
    __pyx_t_12 = 0;
    __pyx_t_13 = 0;
    if (__Pyx_Print(0, __pyx_t_23, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    __pyx_t_23 = __Pyx_PyInt_From_int(__pyx_v_end_beat); if (unlikely(!__pyx_t_23)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_23);
    __pyx_t_13 = __Pyx_PyInt_From_int((__pyx_v_offset + __pyx_v_l_over_2)); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_22 = -1;
    __pyx_t_24.data = __pyx_v_pen.data;
    __pyx_t_24.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_24, 0);
    __pyx_t_24.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_24.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_t_12 = PyInt_FromSsize_t((__pyx_t_24.shape[1])); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_12);
    __PYX_XDEC_MEMVIEW(&__pyx_t_24, 1);
    __pyx_t_14 = PyTuple_New(6); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_INCREF(__pyx_kp_s_backwrd_end_beat);
    PyTuple_SET_ITEM(__pyx_t_14, 0, __pyx_kp_s_backwrd_end_beat);
    __Pyx_GIVEREF(__pyx_kp_s_backwrd_end_beat);
    PyTuple_SET_ITEM(__pyx_t_14, 1, __pyx_t_23);
    __Pyx_GIVEREF(__pyx_t_23);
    __Pyx_INCREF(__pyx_kp_s_offset);
    PyTuple_SET_ITEM(__pyx_t_14, 2, __pyx_kp_s_offset);
    __Pyx_GIVEREF(__pyx_kp_s_offset);
    PyTuple_SET_ITEM(__pyx_t_14, 3, __pyx_t_13);
    __Pyx_GIVEREF(__pyx_t_13);
    __Pyx_INCREF(__pyx_kp_s_length);
    PyTuple_SET_ITEM(__pyx_t_14, 4, __pyx_kp_s_length);
    __Pyx_GIVEREF(__pyx_kp_s_length);
    ...
    __pyx_t_13 = 0;
    __pyx_t_12 = 0;
    if (__Pyx_Print(0, __pyx_t_14, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
 ...
 */
    {
        ...
        /*try:*/ {
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_22) firstprivate(__pyx_t_27, __pyx_t_28) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      for (__pyx_t_25 = 0; __pyx_t_25 < __pyx_t_26; __pyx_t_25++){
                          ...
                          {
                              __pyx_v_prange_i = 0 + 1 * __pyx_t_25;
...
__pyx_f_9radiotool_10algorithms_15par_build_table_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_27, __pyx_v_start_beat, -1, __pyx_v_offset, __pyx_v_p, __pyx_v_f, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3);
 ...
 */
                                __pyx_t_22 = -1;
                                __pyx_t_28.data = __pyx_v_pen.data;
                                __pyx_t_28.memview = __pyx_v_pen.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_28, 0);
                                __pyx_t_28.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_28.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_f_9radiotool_10algorithms_15par_build_table_backward_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_28, -1, __pyx_v_end_beat, (__pyx_v_offset + __pyx_v_l_over_2), __pyx_v_p, __pyx_v_g, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
 ...
 *         # stride = f.shape[0] / 4
 */
    if (__Pyx_PrintOne(0, __pyx_kp_s_finding_minimum) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 417; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
      ...
      if (!__pyx_t_4) {
        ...
        __pyx_t_2 = ((((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_29 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_30 * __pyx_v_g.strides[0]) )))) < __pyx_v_minval) != 0);
        __pyx_t_1 = __pyx_t_2;
      } else {
        __pyx_t_1 = __pyx_t_4;
      }
 ...
 */
        ...
        __pyx_v_minval = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_31 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_32 * __pyx_v_g.strides[0]) ))));
 ...
 * 
 */
    __pyx_t_14 = __Pyx_PyInt_From_int((__pyx_v_l_over_2 + __pyx_v_offset)); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_opt_i); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = PyTuple_New(2); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    ...
    __pyx_t_14 = 0;
    __pyx_t_12 = 0;
    __pyx_t_12 = __Pyx_PyString_Format(__pyx_kp_s_setting_time_d_to_d_3, __pyx_t_13); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_12) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
 ...
 */
    __pyx_t_34 = -1;
    __pyx_t_33.data = __pyx_v_pen.data;
    __pyx_t_33.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_33, 0);
    __pyx_t_33.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_33.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_f_9radiotool_10algorithms_15par_build_table_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_33, __pyx_v_start_beat, __pyx_v_opt_i, __pyx_v_offset, __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
 ...
 */
    __pyx_t_34 = -1;
    __pyx_t_35.data = __pyx_v_pen.data;
    __pyx_t_35.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_35, 0);
    __pyx_t_35.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_35.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_f_9radiotool_10algorithms_15par_build_table_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_35, __pyx_v_opt_i, __pyx_v_end_beat, (__pyx_v_l_over_2 + __pyx_v_offset), __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_backwrd_end_beat, __pyx_k_backwrd_end_beat, sizeof(__pyx_k_backwrd_end_beat), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_finding_minimum, __pyx_k_finding_minimum, sizeof(__pyx_k_finding_minimum), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_forward_start_beat, __pyx_k_forward_start_beat, sizeof(__pyx_k_forward_start_beat), 0, 0, 1, 0},
