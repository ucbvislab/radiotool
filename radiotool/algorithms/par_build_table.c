/* Generated by Cython 0.20.1 on Sat Mar 15 19:00:38 2014 */
...
static CYTHON_INLINE int __pyx_f_9radiotool_10algorithms_15par_build_table_minimum(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...

{
    ...
    /* "radiotool/algorithms/par_build_table.pyx":137
 *     if start_beat != -1:
 *         cost[:] = 99999999  # N.inf
 *         cost[start_beat] = get_pen_value(pen, start_beat, 0, global_start_l, p)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":139
 *         cost[start_beat] = get_pen_value(pen, start_beat, 0, global_start_l, p)
 *     else:
 *         get_pen_column(pen, 0, cost, global_start_l, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":143
 *     # optimize
 *     for l in range(1, pen.shape[1]):
 *         if l == pen.shape[1] - 1 and end_beat != -1:             # <<<<<<<<<<<<<<
 *             # handle end beat set
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":146
 *             # handle end beat set
 *             end_pen = get_pen_value(pen, end_beat, l, global_start_l + l, p)
 *             get_tc_column(tc, end_beat, vals_col, 0, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_6) {
          ...
          /* "radiotool/algorithms/par_build_table.pyx":152
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + end_pen < minval:
 *                     minval = vals_col[i] + cost[i] + end_pen             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":154
 *                     minval = vals_col[i] + cost[i] + end_pen
 * 
 *             min_vals[end_beat] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /*else*/ {
      ...
      /* "radiotool/algorithms/par_build_table.pyx":157
 * 
 *         else:
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":158
 *         else:
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)
 *             for idx in range(p.all_full):             # <<<<<<<<<<<<<<
 *                 get_tc_column(tc, idx, vals_col, 0, p)
 ...
 */
      ...
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/par_build_table.pyx":159
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)
 *             for idx in range(p.all_full):
 *                 get_tc_column(tc, idx, vals_col, 0, p)             # <<<<<<<<<<<<<<
 * 
 *                 minval = -1
 */
        __pyx_f_9radiotool_10algorithms_15par_build_table_get_tc_column(__pyx_v_tc, __pyx_v_idx, __pyx_v_vals_col, 0, __pyx_v_p);

        /* "radiotool/algorithms/par_build_table.pyx":161
 *                 get_tc_column(tc, idx, vals_col, 0, p)
 * 
 *                 minval = -1             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "radiotool/algorithms/par_build_table.pyx":162
 * 
 *                 minval = -1
 *                 for i in range(cost.shape[0]):             # <<<<<<<<<<<<<<
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 ...
 */
        ...
        for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_10; __pyx_t_17+=1) {
          ...
          /* "radiotool/algorithms/par_build_table.pyx":163
 *                 minval = -1
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:             # <<<<<<<<<<<<<<
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/par_build_table.pyx":164
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]             # <<<<<<<<<<<<<<
 *                 min_vals[idx] = minval
 ...
 */
        ...
        /* "radiotool/algorithms/par_build_table.pyx":165
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":167
 *                 min_vals[idx] = minval
 * 
 *         cost[:] = min_vals             # <<<<<<<<<<<<<<
 * 
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_min_vals, __pyx_t_24, 1, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "radiotool/algorithms/par_build_table.pyx":170
 * 
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":179
 *     # generate initial cost
 *     if end_beat != -1:
 *         cost[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)
...

{
    ...
    /* "radiotool/algorithms/par_build_table.pyx":180
 *     if end_beat != -1:
 *         cost[:] = 99999999  # N.inf
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":182
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)
 *     else:
 *         get_pen_column(pen, pen.shape[1] - 1, cost, global_start_l + pen.shape[1] - 1, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":189
 *             # handle start beat set
 *             start_pen = get_pen_value(pen, start_beat, l, global_start_l + l, p)
 *             get_tc_column(tc, start_beat, vals_col, 1, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":191
 *             get_tc_column(tc, start_beat, vals_col, 1, p)
 * 
 *             min_vals[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *             minval = -1
...

{
      ...
      /* "radiotool/algorithms/par_build_table.pyx":192
 * 
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1             # <<<<<<<<<<<<<<
 *             for i in range(vals_col.shape[0]):
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":193
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1
 *             for i in range(vals_col.shape[0]):             # <<<<<<<<<<<<<<
 *                 if minval == -1 or vals_col[i] + cost[i] + start_pen < minval:
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9+=1) {
        ...
        /* "radiotool/algorithms/par_build_table.pyx":194
 *             minval = -1
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + start_pen < minval:             # <<<<<<<<<<<<<<
 *                     minval = vals_col[i] + cost[i] + start_pen
 ...
 */
      ...
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/par_build_table.pyx":202
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)
 *             for idx in xrange(p.all_full):
 *                 get_tc_column(tc, idx, vals_col, 1, p)             # <<<<<<<<<<<<<<
 * 
 *                 minval = -1
 */
        __pyx_f_9radiotool_10algorithms_15par_build_table_get_tc_column(__pyx_v_tc, __pyx_v_idx, __pyx_v_vals_col, 1, __pyx_v_p);
 ...
 */
        ...
        for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_10; __pyx_t_17+=1) {
          ...
          /* "radiotool/algorithms/par_build_table.pyx":206
 *                 minval = -1
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:             # <<<<<<<<<<<<<<
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/par_build_table.pyx":207
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]             # <<<<<<<<<<<<<<
 *                 min_vals[idx] = minval
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":216
 *     cdef int idx
 *     cdef int opt_i = 0
 *     cdef double minval = buffer1[0] + buffer2[0]             # <<<<<<<<<<<<<<
 *     for idx in range(1, buffer1.shape[0]):
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":217
 *     cdef int opt_i = 0
 *     cdef double minval = buffer1[0] + buffer2[0]
 *     for idx in range(1, buffer1.shape[0]):             # <<<<<<<<<<<<<<
 *         if buffer1[idx] + buffer2[idx] < minval:
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "radiotool/algorithms/par_build_table.pyx":219
 *     for idx in range(1, buffer1.shape[0]):
 *         if buffer1[idx] + buffer2[idx] < minval:
 *             minval = buffer1[idx] + buffer2[idx]             # <<<<<<<<<<<<<<
 *             opt_i = idx
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":220
 *         if buffer1[idx] + buffer2[idx] < minval:
 *             minval = buffer1[idx] + buffer2[idx]
 *             opt_i = idx             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":222
 *             opt_i = idx
 * 
 *     return opt_i             # <<<<<<<<<<<<<<
 * 
...
/* "radiotool/algorithms/par_build_table.pyx":225
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_15par_build_table_divide_and_conquer_cost_and_path(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_offset, __Pyx_memviewslice __pyx_v_global_path, struct __pyx_t_9radiotool_10algorithms_15par_build_table_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_mv1, __Pyx_memviewslice __pyx_v_mv2, __Pyx_memviewslice __pyx_v_mv3, __Pyx_memviewslice __pyx_v_mv4, __Pyx_memviewslice __pyx_v_mv5, __Pyx_memviewslice __pyx_v_mv6) {
  ...
  arrayobject *__pyx_v_itemplate = 0;
  PyObject *__pyx_v_ar1 = 0;
  PyObject *__pyx_v_ar2 = 0;
  __Pyx_memviewslice __pyx_v_min_val_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_opt_i_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  /* "radiotool/algorithms/par_build_table.pyx":231
 ...
 *     cdef ar1, ar2
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 240; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_dtemplate = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 241; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_itemplate = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 *     min_val_arr = ar1
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, 4, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 245; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_ar1 = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":246
 *     cdef int[:] opt_i_arr
 *     ar1 = clone(dtemplate, 4, False)
 *     ar2 = clone(itemplate, 4, False)             # <<<<<<<<<<<<<<
 *     min_val_arr = ar1
 *     opt_i_arr = ar2
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_itemplate, 4, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 246; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_ar2 = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":247
 *     ar1 = clone(dtemplate, 4, False)
 *     ar2 = clone(itemplate, 4, False)
 *     min_val_arr = ar1             # <<<<<<<<<<<<<<
 *     opt_i_arr = ar2
 ...
 *     if l == 0:
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_ar2);
  if (unlikely(!__pyx_t_3.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 248; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_opt_i_arr = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "radiotool/algorithms/par_build_table.pyx":250
 *     opt_i_arr = ar2
 * 
 *     if l == 0:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":252
 *     if l == 0:
 *         pass
 *     elif l == 1:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":256
 *     elif l == 2 and start_beat != -1 and end_beat != -1:
 *         pass
 *     elif l == 2 and start_beat != -1:             # <<<<<<<<<<<<<<
 *         new_pen = mv1
 ...
 */
  ...
  if (__pyx_t_5) {
    __pyx_t_4 = ((__pyx_v_start_beat != -1) != 0);
    __pyx_t_7 = __pyx_t_4;
  } else {
    __pyx_t_7 = __pyx_t_5;
  }
  if (__pyx_t_7) {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":257
 *         pass
 *     elif l == 2 and start_beat != -1:
 *         new_pen = mv1             # <<<<<<<<<<<<<<
 *         get_pen_column(pen, 1, new_pen, offset, p)
 ...
 */
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_8 * __pyx_v_global_path.strides[0]) )) = __pyx_v_start_beat;
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":266
 * 
 *         minval = -1.0
 *         opt_i = 0             # <<<<<<<<<<<<<<
 *         for i in range(tc_column.shape[0]):
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":267
 *         minval = -1.0
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):             # <<<<<<<<<<<<<<
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 ...
 */
    __pyx_t_9 = (__pyx_v_tc_column.shape[0]);
 ...
 */
      ...
      if (!__pyx_t_7) {
        __pyx_t_11 = __pyx_v_i;
        __pyx_t_12 = __pyx_v_i;
        __pyx_t_5 = ((((*((double *) ( /* dim=0 */ (__pyx_v_tc_column.data + __pyx_t_11 * __pyx_v_tc_column.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_new_pen.data + __pyx_t_12 * __pyx_v_new_pen.strides[0]) )))) < __pyx_v_minval) != 0);
        __pyx_t_4 = __pyx_t_5;
      } else {
        __pyx_t_4 = __pyx_t_7;
      }
 ...
 */
        __pyx_t_13 = __pyx_v_i;
        __pyx_t_14 = __pyx_v_i;
        __pyx_v_minval = ((*((double *) ( /* dim=0 */ (__pyx_v_tc_column.data + __pyx_t_13 * __pyx_v_tc_column.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_new_pen.data + __pyx_t_14 * __pyx_v_new_pen.strides[0]) ))));
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":272
 *                 opt_i = i
 * 
 *         global_path[offset + 1] = opt_i             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_4 = ((__pyx_v_l == 2) != 0);
  if (__pyx_t_4) {
    __pyx_t_7 = ((__pyx_v_end_beat != -1) != 0);
    __pyx_t_5 = __pyx_t_7;
  } else {
    __pyx_t_5 = __pyx_t_4;
  }
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":279
 *         get_pen_column(pen, 0, new_pen, offset, p)
 * 
 *         tc_column = mv2             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":283
 * 
 *         minval = -1.0
 *         opt_i = 0             # <<<<<<<<<<<<<<
 *         for i in range(tc_column.shape[0]):
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "radiotool/algorithms/par_build_table.pyx":285
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:             # <<<<<<<<<<<<<<
 *                 minval = tc_column[i] + new_pen[i]
 ...
 */
      ...
      if (!__pyx_t_5) {
        ...
        __pyx_t_4 = ((((*((double *) ( /* dim=0 */ (__pyx_v_tc_column.data + __pyx_t_16 * __pyx_v_tc_column.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_new_pen.data + __pyx_t_17 * __pyx_v_new_pen.strides[0]) )))) < __pyx_v_minval) != 0);
        __pyx_t_7 = __pyx_t_4;
      } else {
        __pyx_t_7 = __pyx_t_5;
      }
      if (__pyx_t_7) {
        ...
        /* "radiotool/algorithms/par_build_table.pyx":286
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 *                 minval = tc_column[i] + new_pen[i]             # <<<<<<<<<<<<<<
 *                 opt_i = i
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":289
 *                 opt_i = i
 * 
 *         global_path[offset] = opt_i             # <<<<<<<<<<<<<<
 ...
 */
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_10 * __pyx_v_global_path.strides[0]) )) = __pyx_v_opt_i;

    /* "radiotool/algorithms/par_build_table.pyx":290
 * 
 *         global_path[offset] = opt_i
 *         global_path[offset + 1] = end_beat             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":293
 * 
 *         # global_path_cost[offset] = N.min(tc_column + new_pen)
 *     elif l == 2:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
    {
        ...
        /*try:*/ {
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_24) firstprivate(__pyx_t_25, __pyx_t_23) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_22; __pyx_t_21++){
                          ...
                          {
                              __pyx_v_prange_i = 0 + 1 * __pyx_t_21;
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 309; __pyx_clineno = __LINE__; goto __pyx_L15_error;}
}

__pyx_f_9radiotool_10algorithms_15par_build_table_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_23, __pyx_v_start_beat, -1, __pyx_v_offset, __pyx_v_p, __pyx_v_f, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3);
 ...
 */
                                ...
                                /* "radiotool/algorithms/par_build_table.pyx":312
 *             elif prange_i == 1:
 *                 backward_space_efficient_cost_with_duration_constraint(
 *                     tc, pen[:, l_over_2:], -1, end_beat, offset + l_over_2, p, g, mv4, mv5, mv6)             # <<<<<<<<<<<<<<
 * 
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 312; __pyx_clineno = __LINE__; goto __pyx_L15_error;}
}

__pyx_f_9radiotool_10algorithms_15par_build_table_backward_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_25, -1, __pyx_v_end_beat, (__pyx_v_offset + __pyx_v_l_over_2), __pyx_v_p, __pyx_v_g, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
 ...
 */
    __pyx_v_stride = ((int)(((double)(__pyx_v_f.shape[0])) / 4.0));
 ...
 */
    {
        ...
        /*try:*/ {
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_31, __pyx_t_37, __pyx_t_36, __pyx_t_24, __pyx_t_30, __pyx_t_40, __pyx_t_55, __pyx_t_56, __pyx_t_48, __pyx_t_54, __pyx_t_34, __pyx_t_39, __pyx_t_28, __pyx_t_44, __pyx_t_29, __pyx_t_50, __pyx_t_42, __pyx_t_32, __pyx_t_38, __pyx_t_53, __pyx_t_46, __pyx_t_7, __pyx_t_45, __pyx_t_52, __pyx_t_47) firstprivate(__pyx_t_43, __pyx_t_33, __pyx_t_41, __pyx_t_26, __pyx_t_27, __pyx_t_49, __pyx_t_51, __pyx_t_35) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
 ...
 */
                                __pyx_t_24 = -1;
                                __pyx_t_26.data = __pyx_v_f.data;
                                __pyx_t_26.memview = __pyx_v_f.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_26, 0);
                                if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_26,
    __pyx_v_f.shape[0], __pyx_v_f.strides[0], __pyx_v_f.suboffsets[0],
    0,
    0,
    &__pyx_t_24,
    0,
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; __pyx_clineno = __LINE__; goto __pyx_L24_error;}
}

__pyx_t_24 = -1;
                                __pyx_t_27.data = __pyx_v_g.data;
                                __pyx_t_27.memview = __pyx_v_g.memview;
...
__pyx_t_24 = __pyx_v_i;
                                *((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_24 * __pyx_v_opt_i_arr.strides[0]) )) = __pyx_f_9radiotool_10algorithms_15par_build_table_minimum(__pyx_t_26, __pyx_t_27);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_26, 0);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_27, 0);
 ...
 */
                                ...
                                __pyx_t_29 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_28 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_30 = __pyx_v_i;
                                __pyx_t_31 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_30 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_32 = __pyx_v_i;
                                *((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_32 * __pyx_v_min_val_arr.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_29 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_31 * __pyx_v_g.strides[0]) ))));
                                goto __pyx_L26;
                              }
                              __pyx_L26:;
 ...
 */
                                __pyx_t_34 = -1;
                                __pyx_t_33.data = __pyx_v_f.data;
                                __pyx_t_33.memview = __pyx_v_f.memview;
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 323; __pyx_clineno = __LINE__; goto __pyx_L24_error;}
}

__pyx_t_34 = -1;
                                __pyx_t_35.data = __pyx_v_g.data;
                                __pyx_t_35.memview = __pyx_v_g.memview;
...
__pyx_t_34 = __pyx_v_i;
                                *((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_34 * __pyx_v_opt_i_arr.strides[0]) )) = (__pyx_v_stride + __pyx_f_9radiotool_10algorithms_15par_build_table_minimum(__pyx_t_33, __pyx_t_35));
                                __PYX_XDEC_MEMVIEW(&__pyx_t_33, 0);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_35, 0);

                                /* "radiotool/algorithms/par_build_table.pyx":324
 *             if i == 1:
 *                 opt_i_arr[i] = stride + minimum(f[stride:2 * stride], g[stride:2 * stride])
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]             # <<<<<<<<<<<<<<
 *             if i == 2:
 ...
 */
                                ...
                                __pyx_t_37 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_36 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_38 = __pyx_v_i;
                                __pyx_t_39 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_38 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_40 = __pyx_v_i;
                                *((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_40 * __pyx_v_min_val_arr.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_37 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_39 * __pyx_v_g.strides[0]) ))));
                                goto __pyx_L27;
                              }
                              __pyx_L27:;
 ...
 */
                              ...
                              if (__pyx_t_7) {
                                ...
                                /* "radiotool/algorithms/par_build_table.pyx":326
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]
 *             if i == 2:
 *                 opt_i_arr[i] = 2 * stride + minimum(f[2 * stride:3 * stride], g[2 * stride:3 * stride])             # <<<<<<<<<<<<<<
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]
 ...
 */
                                __pyx_t_42 = -1;
                                __pyx_t_41.data = __pyx_v_f.data;
                                __pyx_t_41.memview = __pyx_v_f.memview;
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L24_error;}
}

__pyx_t_42 = -1;
                                __pyx_t_43.data = __pyx_v_g.data;
                                __pyx_t_43.memview = __pyx_v_g.memview;
...
__pyx_t_42 = __pyx_v_i;
                                *((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_42 * __pyx_v_opt_i_arr.strides[0]) )) = ((2 * __pyx_v_stride) + __pyx_f_9radiotool_10algorithms_15par_build_table_minimum(__pyx_t_41, __pyx_t_43));
                                __PYX_XDEC_MEMVIEW(&__pyx_t_41, 0);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_43, 0);

                                /* "radiotool/algorithms/par_build_table.pyx":327
 *             if i == 2:
 *                 opt_i_arr[i] = 2 * stride + minimum(f[2 * stride:3 * stride], g[2 * stride:3 * stride])
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]             # <<<<<<<<<<<<<<
 *             if i == 3:
 ...
 */
                                ...
                                __pyx_t_45 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_44 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_46 = __pyx_v_i;
                                __pyx_t_47 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_46 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_48 = __pyx_v_i;
                                *((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_48 * __pyx_v_min_val_arr.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_45 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_47 * __pyx_v_g.strides[0]) ))));
                                goto __pyx_L28;
                              }
                              __pyx_L28:;
 ...
 */
                              ...
                              if (__pyx_t_7) {
                                ...
                                /* "radiotool/algorithms/par_build_table.pyx":329
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]
 *             if i == 3:
 *                 opt_i_arr[i] = 3 * stride + minimum(f[3 * stride:], g[3 * stride:])             # <<<<<<<<<<<<<<
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]
 ...
 */
                                __pyx_t_50 = -1;
                                __pyx_t_49.data = __pyx_v_f.data;
                                __pyx_t_49.memview = __pyx_v_f.memview;
    ...
    1) < 0))
{
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 329; __pyx_clineno = __LINE__; goto __pyx_L24_error;}
}

__pyx_t_50 = -1;
                                __pyx_t_51.data = __pyx_v_g.data;
                                __pyx_t_51.memview = __pyx_v_g.memview;
...
__pyx_t_50 = __pyx_v_i;
                                *((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_50 * __pyx_v_opt_i_arr.strides[0]) )) = ((3 * __pyx_v_stride) + __pyx_f_9radiotool_10algorithms_15par_build_table_minimum(__pyx_t_49, __pyx_t_51));
                                __PYX_XDEC_MEMVIEW(&__pyx_t_49, 0);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_51, 0);

                                /* "radiotool/algorithms/par_build_table.pyx":330
 *             if i == 3:
 *                 opt_i_arr[i] = 3 * stride + minimum(f[3 * stride:], g[3 * stride:])
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                ...
                                __pyx_t_53 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_52 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_54 = __pyx_v_i;
                                __pyx_t_55 = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_54 * __pyx_v_opt_i_arr.strides[0]) )));
                                __pyx_t_56 = __pyx_v_i;
                                *((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_56 * __pyx_v_min_val_arr.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_53 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_55 * __pyx_v_g.strides[0]) ))));
                                goto __pyx_L29;
                              }
                              __pyx_L29:;
                              goto __pyx_L31;
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":332
 *                 min_val_arr[i] = f[opt_i_arr[i]] + g[opt_i_arr[i]]
 * 
 *         opt_i = 0             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":333
 * 
 *         opt_i = 0
 *         minval = min_val_arr[0]             # <<<<<<<<<<<<<<
 *         if min_val_arr[1] < minval:
 ...
 */
    __pyx_t_9 = 0;
    __pyx_v_minval = (*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_9 * __pyx_v_min_val_arr.strides[0]) )));
 ...
 */
    __pyx_t_57 = 1;
    __pyx_t_7 = (((*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_57 * __pyx_v_min_val_arr.strides[0]) ))) < __pyx_v_minval) != 0);
    if (__pyx_t_7) {

      /* "radiotool/algorithms/par_build_table.pyx":335
 *         minval = min_val_arr[0]
 *         if min_val_arr[1] < minval:
 *             opt_i = 1             # <<<<<<<<<<<<<<
 *             minval = min_val_arr[1]
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":336
 *         if min_val_arr[1] < minval:
 *             opt_i = 1
 *             minval = min_val_arr[1]             # <<<<<<<<<<<<<<
 *         if min_val_arr[2] < minval:
 ...
 */
      __pyx_t_58 = 1;
      __pyx_v_minval = (*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_58 * __pyx_v_min_val_arr.strides[0]) )));
      goto __pyx_L32;
    }
    __pyx_L32:;
 ...
 */
    __pyx_t_59 = 2;
    __pyx_t_7 = (((*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_59 * __pyx_v_min_val_arr.strides[0]) ))) < __pyx_v_minval) != 0);
    if (__pyx_t_7) {

      /* "radiotool/algorithms/par_build_table.pyx":338
 *             minval = min_val_arr[1]
 *         if min_val_arr[2] < minval:
 *             opt_i = 2             # <<<<<<<<<<<<<<
 *             minval = min_val_arr[2]
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":339
 *         if min_val_arr[2] < minval:
 *             opt_i = 2
 *             minval = min_val_arr[2]             # <<<<<<<<<<<<<<
 *         if min_val_arr[3] < minval:
 ...
 */
      __pyx_t_60 = 2;
      __pyx_v_minval = (*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_60 * __pyx_v_min_val_arr.strides[0]) )));
      goto __pyx_L33;
    }
    __pyx_L33:;

    /* "radiotool/algorithms/par_build_table.pyx":340
 *             opt_i = 2
 *             minval = min_val_arr[2]
 *         if min_val_arr[3] < minval:             # <<<<<<<<<<<<<<
 *             opt_i = 3
 ...
 */
    __pyx_t_61 = 3;
    __pyx_t_7 = (((*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_61 * __pyx_v_min_val_arr.strides[0]) ))) < __pyx_v_minval) != 0);
    if (__pyx_t_7) {

      /* "radiotool/algorithms/par_build_table.pyx":341
 *             minval = min_val_arr[2]
 *         if min_val_arr[3] < minval:
 *             opt_i = 3             # <<<<<<<<<<<<<<
 *             minval = min_val_arr[3]
 ...
 */
      ...
      /* "radiotool/algorithms/par_build_table.pyx":342
 *         if min_val_arr[3] < minval:
 *             opt_i = 3
 *             minval = min_val_arr[3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_62 = 3;
      __pyx_v_minval = (*((double *) ( /* dim=0 */ (__pyx_v_min_val_arr.data + __pyx_t_62 * __pyx_v_min_val_arr.strides[0]) )));
      goto __pyx_L34;
    }
    __pyx_L34:;

    /* "radiotool/algorithms/par_build_table.pyx":344
 *             minval = min_val_arr[3]
 * 
 *         opt_i = opt_i_arr[opt_i]             # <<<<<<<<<<<<<<
 * 
 *         # ## -- OLD WAY -- ##
 */
    __pyx_t_63 = __pyx_v_opt_i;
    __pyx_v_opt_i = (*((int *) ( /* dim=0 */ (__pyx_v_opt_i_arr.data + __pyx_t_63 * __pyx_v_opt_i_arr.strides[0]) )));
 ...
 * 
 */
    __pyx_t_64 = (__pyx_v_l_over_2 + __pyx_v_offset);
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_64 * __pyx_v_global_path.strides[0]) )) = __pyx_v_opt_i;
 ...
 */
    __pyx_t_66 = -1;
    __pyx_t_65.data = __pyx_v_pen.data;
    __pyx_t_65.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_65, 0);
    __pyx_t_65.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_65.strides[0] = __pyx_v_pen.strides[0];
    __pyx_t_65.suboffsets[0] = -1;
...
__pyx_f_9radiotool_10algorithms_15par_build_table_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_65, __pyx_v_start_beat, __pyx_v_opt_i, __pyx_v_offset, __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
 ...
 */
    ...
    /* "radiotool/algorithms/par_build_table.pyx":365
 *         # second half
 *         divide_and_conquer_cost_and_path(
 ...
 */
    __pyx_t_66 = -1;
    __pyx_t_67.data = __pyx_v_pen.data;
    __pyx_t_67.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_67, 0);
    __pyx_t_67.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_67.strides[0] = __pyx_v_pen.strides[0];
    __pyx_t_67.suboffsets[0] = -1;
...
__pyx_f_9radiotool_10algorithms_15par_build_table_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_67, __pyx_v_opt_i, __pyx_v_end_beat, (__pyx_v_l_over_2 + __pyx_v_offset), __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);
 ...
 */
  ...
  __Pyx_XDECREF((PyObject *)__pyx_v_itemplate);
  __Pyx_XDECREF(__pyx_v_ar1);
  __Pyx_XDECREF(__pyx_v_ar2);
  __PYX_XDEC_MEMVIEW(&__pyx_v_min_val_arr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_opt_i_arr, 1);
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":377
 * 
 *     if max_beats != -1 and min_beats != -1:
 *         max_beats_with_padding = min_beats + max_beats             # <<<<<<<<<<<<<<
 *     elif max_beats != -1:
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":378
 *     if max_beats != -1 and min_beats != -1:
 *         max_beats_with_padding = min_beats + max_beats
 *     elif max_beats != -1:             # <<<<<<<<<<<<<<
 *         # 8? Two measures of padding? Just a thought
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":382
 *         max_beats_with_padding = max_beats + 8
 *     elif min_beats != -1:
 *         max_beats = -1             # <<<<<<<<<<<<<<
 *         max_beats_with_padding = min_beats
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/par_build_table.pyx":385
 *         max_beats_with_padding = min_beats
 *     else:
 *         max_beats_with_padding = 1             # <<<<<<<<<<<<<<
 *         max_beats = 1
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":392
 *     p.pen_val = 1.0
 *     p.p0 = first_pause
 *     p.n_beats = p.p0             # <<<<<<<<<<<<<<
 *     p.n_pauses = trans_cost.shape[0] - p.p0
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":393
 *     p.p0 = first_pause
 *     p.n_beats = p.p0
 *     p.n_pauses = trans_cost.shape[0] - p.p0             # <<<<<<<<<<<<<<
 *     p.min_beats = min_beats
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":396
 *     p.min_beats = min_beats
 *     p.max_beats = max_beats
 *     p.max_beats_with_padding = max_beats_with_padding             # <<<<<<<<<<<<<<
 *     p.p0_full = p.n_beats * p.max_beats_with_padding
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":397
 *     p.max_beats = max_beats
 *     p.max_beats_with_padding = max_beats_with_padding
 *     p.p0_full = p.n_beats * p.max_beats_with_padding             # <<<<<<<<<<<<<<
 *     p.all_full = p.p0_full + p.n_pauses
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":401
 * 
 *     # double arrays for use throughout the computation
 *     cdef array dtemplate = array('d')             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array1 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":405
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 *     array1 = clone(dtemplate, p.all_full, False)
 *     array2 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array3 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array2 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":406
 *     array1 = clone(dtemplate, p.all_full, False)
 *     array2 = clone(dtemplate, p.all_full, False)
 *     array3 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array4 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array3 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":407
 *     array2 = clone(dtemplate, p.all_full, False)
 *     array3 = clone(dtemplate, p.all_full, False)
 *     array4 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array5 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array4 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":408
 *     array3 = clone(dtemplate, p.all_full, False)
 *     array4 = clone(dtemplate, p.all_full, False)
 *     array5 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array6 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 408; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 412; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_f = __pyx_t_6;
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 413; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_g = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 414; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 415; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv2 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/par_build_table.pyx":416
 *     mv1 = array3
 *     mv2 = array4
 *     mv3 = array5             # <<<<<<<<<<<<<<
 *     mv4 = array6
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 416; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv3 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/par_build_table.pyx":417
 *     mv2 = array4
 *     mv3 = array5
 *     mv4 = array6             # <<<<<<<<<<<<<<
 *     mv5 = array7
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":418
 *     mv3 = array5
 *     mv4 = array6
 *     mv5 = array7             # <<<<<<<<<<<<<<
 *     mv6 = array8
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":419
 *     mv4 = array6
 *     mv5 = array7
 *     mv6 = array8             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":421
 *     mv6 = array8
 * 
 *     cdef array ar, template = array('i')             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 421; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_template = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":422
 * 
 *     cdef array ar, template = array('i')
 *     ar = clone(template, penalty.shape[1], False)             # <<<<<<<<<<<<<<
 *     cdef int[:] global_path = ar
 * 
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template, (__pyx_v_penalty.shape[1]), 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 422; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_ar = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/par_build_table.pyx":423
 *     cdef array ar, template = array('i')
 *     ar = clone(template, penalty.shape[1], False)
 *     cdef int[:] global_path = ar             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 423; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_global_path = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/par_build_table.pyx":425
 *     cdef int[:] global_path = ar
 * 
 *     divide_and_conquer_cost_and_path(trans_cost, penalty, -1, -1, 0, global_path, p,             # <<<<<<<<<<<<<<
 *         f, g, mv1, mv2, mv3, mv4, mv5, mv6)
 ...
 */
  ...
  /* "radiotool/algorithms/par_build_table.pyx":428
 *         f, g, mv1, mv2, mv3, mv4, mv5, mv6)
 * 
 *     return global_path             # <<<<<<<<<<<<<<
 */
...
static PyObject *__pyx_pw_9radiotool_10algorithms_15par_build_table_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("build_table (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_penalty)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "build_table") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_trans_cost = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_trans_cost.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_penalty = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_penalty.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_min_beats = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_min_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 372; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_min_beats = ((int)-1);
    }
    if (values[3]) {
      __pyx_v_max_beats = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_max_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 372; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_max_beats = ((int)-1);
    }
    if (values[4]) {
      __pyx_v_first_pause = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_first_pause == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 372; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("radiotool.algorithms.par_build_table.build_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_9radiotool_10algorithms_15par_build_table_build_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, int __pyx_v_min_beats, int __pyx_v_max_beats, int __pyx_v_first_pause) {
  ...
  if (unlikely(!__pyx_v_trans_cost.memview)) { __Pyx_RaiseUnboundLocalError("trans_cost"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_penalty.memview)) { __Pyx_RaiseUnboundLocalError("penalty"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_2.__pyx_n = 3;
  __pyx_t_2.min_beats = __pyx_v_min_beats;
  __pyx_t_2.max_beats = __pyx_v_max_beats;
  __pyx_t_2.first_pause = __pyx_v_first_pause;
  __pyx_t_1 = __pyx_f_9radiotool_10algorithms_15par_build_table_build_table(__pyx_v_trans_cost, __pyx_v_penalty, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef ar1, ar2
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_d); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 240; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef double[:] min_val_arr
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 241; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_n_s_d); if (unlikely(!__pyx_tuple__3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef int[:] global_path = ar
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 421; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
