/* Generated by Cython 0.20.1 on Sat Mar 15 19:04:02 2014 */
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":24
 * cdef void get_tc_column(double[:, :] tc, int column, double[:] tc_column, int backward, Params p):
 *     cdef int tc_index = 0
 *     cdef int beat_seg_i = 0             # <<<<<<<<<<<<<<
 *     cdef int i, j
 ...
 */
    ...
    for (__pyx_t_3 = __pyx_v_p.p0_full; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":45
 * 
 *         for i in range(p.p0_full, p.all_full):
 *             tc_column[i] = tc[tc_index, p.p0 + i - p.p0_full]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":53
 *             tc_column[i] += p.pen_val
 *     elif (column < p.n_beats * p.min_beats) and backward:
 *         tc_column[p.p0_full] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":60
 *             tc_column[i] += p.pen_val
 *     elif (p.p0_full > column >= p.n_beats * p.max_beats) and backward:
 *         tc_column[p.p0_full] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_21 = __pyx_v_p.n_beats; __pyx_t_21 < __pyx_t_19; __pyx_t_21+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":68
 *     elif (column >= p.p0_full) and backward:
 *         for i in range(p.n_beats, p.p0_full):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      for (__pyx_t_19 = ((__pyx_v_beat_seg_i + 1) * __pyx_v_p.n_beats); __pyx_t_19 < __pyx_t_26; __pyx_t_19+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":83
 *         elif (beat_seg_i < p.max_beats_with_padding - 1) and backward:
 *             for i in range((beat_seg_i + 1) * p.n_beats, (beat_seg_i + 2) * p.n_beats):
 *                 tc_column[i] -= p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      for (__pyx_t_19 = (__pyx_v_beat_seg_i * __pyx_v_p.n_beats); __pyx_t_19 < __pyx_t_26; __pyx_t_19+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":89
 *         if p.max_beats == -1 and (beat_seg_i == p.min_beats):
 *             for i in range(beat_seg_i * p.n_beats, (beat_seg_i + 1) * p.n_beats):
 *                 tc_column[i] -= p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":98
 *     else:
 *         pen_index = i % p.n_beats
 *     cdef double new_pen = pen[pen_index, l]             # <<<<<<<<<<<<<<
 * 
...
/* "radiotool/algorithms/build_table_mem_efficient.pyx":107
 *     return new_pen
 * 
 * cdef void get_pen_column(double[:, :] pen, int column, double[:] new_pen, int global_start_l, Params p):             # <<<<<<<<<<<<<<
 *     cdef int i, j
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__Pyx_memviewslice __pyx_v_pen, int __pyx_v_column, __Pyx_memviewslice __pyx_v_new_pen, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p) {
  ...
  __Pyx_TraceCall("get_pen_column", __pyx_f[0], 107);
 ...
 */
  ...
  for (__pyx_t_2 = __pyx_v_p.p0_full; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":115
 * 
 *     for i in range(p.p0_full, p.all_full):
 *         new_pen[i] = pen[p.p0 + i - p.p0_full, column]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_2 = __pyx_v_p.n_beats; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":121
 *     if global_start_l == 0:
 *         for i in range(p.n_beats, p.p0_full):
 *             new_pen[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
...
/* "radiotool/algorithms/build_table_mem_efficient.pyx":124
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_pen_val, __Pyx_memviewslice __pyx_v_vals_col, __Pyx_memviewslice __pyx_v_min_vals) {
  ...
  __Pyx_TraceCall("space_efficient_cost_with_duration_constraint", __pyx_f[0], 124);
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":156
 *         else:
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)
 *             for idx in range(p.all_full):             # <<<<<<<<<<<<<<
 *                 get_tc_column(tc, idx, vals_col, 0, p)
 ...
 */
      ...
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":157
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)
 *             for idx in range(p.all_full):
 *                 get_tc_column(tc, idx, vals_col, 0, p)             # <<<<<<<<<<<<<<
 * 
 *                 minval = -1
 */
        __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__pyx_v_tc, __pyx_v_idx, __pyx_v_vals_col, 0, __pyx_v_p);

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":159
 *                 get_tc_column(tc, idx, vals_col, 0, p)
 * 
 *                 minval = -1             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":160
 * 
 *                 minval = -1
 *                 for i in range(cost.shape[0]):             # <<<<<<<<<<<<<<
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 ...
 */
        ...
        for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_10; __pyx_t_17+=1) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":161
 *                 minval = -1
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:             # <<<<<<<<<<<<<<
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":162
 *                 for i in range(cost.shape[0]):
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]             # <<<<<<<<<<<<<<
 *                 min_vals[idx] = minval
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":163
 *                     if minval == -1 or vals_col[i] + cost[i] + pen_val[idx] < minval:
 *                         minval = vals_col[i] + cost[i] + pen_val[idx]
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":165
 *                 min_vals[idx] = minval
 * 
 *         cost[:] = min_vals             # <<<<<<<<<<<<<<
 * 
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_min_vals, __pyx_t_24, 1, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_backward_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_pen_val, __Pyx_memviewslice __pyx_v_vals_col, __Pyx_memviewslice __pyx_v_min_vals) {
  ...
  __Pyx_TraceCall("backward_space_efficient_cost_with_duration_constraint", __pyx_f[0], 170);

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":178
 * 
 *     # generate initial cost
 *     if end_beat != -1:             # <<<<<<<<<<<<<<
 *         cost[:] = 99999999  # N.inf
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":188
 *         if l == 0 and start_beat != -1:
 *             # handle start beat set
 *             start_pen = get_pen_value(pen, start_beat, l, global_start_l + l, p)             # <<<<<<<<<<<<<<
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_min_vals, __pyx_t_24, 1, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 210; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __PYX_XDEC_MEMVIEW(&__pyx_t_24, 1);
  }
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_offset, __Pyx_memviewslice __pyx_v_global_path, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_mv1, __Pyx_memviewslice __pyx_v_mv2, __Pyx_memviewslice __pyx_v_mv3, __Pyx_memviewslice __pyx_v_mv4, __Pyx_memviewslice __pyx_v_mv5, __Pyx_memviewslice __pyx_v_mv6) {
  ...
  __Pyx_TraceCall("divide_and_conquer_cost_and_path", __pyx_f[0], 215);

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":221
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":248
 *                 opt_i = i
 * 
 *         global_path[offset + 1] = opt_i             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_memviewslice __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_9radiotool_10algorithms_25build_table_mem_efficient_build_table *__pyx_optional_args) {
  ...
  __Pyx_TraceCall("build_table", __pyx_f[0], 307);
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 337; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 343; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 345; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *     f = array1
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 346; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *     g = array2
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 351; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 354; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 355; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 357; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 * 
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template, (__pyx_v_penalty.shape[1]), 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 358; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 359; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pw_9radiotool_10algorithms_25build_table_mem_efficient_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("build_table (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_penalty)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "build_table") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_trans_cost = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_trans_cost.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_penalty = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_penalty.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_min_beats = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_min_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 308; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_min_beats = ((int)-1);
    }
    if (values[3]) {
      __pyx_v_max_beats = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_max_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 308; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_max_beats = ((int)-1);
    }
    if (values[4]) {
      __pyx_v_first_pause = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_first_pause == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 308; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("radiotool.algorithms.build_table_mem_efficient.build_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_9radiotool_10algorithms_25build_table_mem_efficient_build_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, int __pyx_v_min_beats, int __pyx_v_max_beats, int __pyx_v_first_pause) {
  ...
  if (unlikely(!__pyx_v_trans_cost.memview)) { __Pyx_RaiseUnboundLocalError("trans_cost"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_penalty.memview)) { __Pyx_RaiseUnboundLocalError("penalty"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_2.__pyx_n = 3;
  __pyx_t_2.min_beats = __pyx_v_min_beats;
  __pyx_t_2.max_beats = __pyx_v_max_beats;
  __pyx_t_2.first_pause = __pyx_v_first_pause;
  __pyx_t_1 = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__pyx_v_trans_cost, __pyx_v_penalty, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_d); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 337; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef int[:] global_path = ar
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 357; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
