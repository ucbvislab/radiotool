/* Generated by Cython 0.20.1 on Mon Mar 17 18:47:17 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__radiotool__algorithms__build_table_mem_efficient
#define __PYX_HAVE_API__radiotool__algorithms__build_table_mem_efficient
#include "string.h"
#include "stdio.h"
#include "pythread.h"
#include "stdlib.h"
...
struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params;
struct __pyx_opt_args_9radiotool_10algorithms_25build_table_mem_efficient_build_table;

/* "radiotool/algorithms/build_table_mem_efficient.pyx":8
...
/* "radiotool/algorithms/build_table_mem_efficient.pyx":404
 * 
 * 
...
/* Module declarations from 'radiotool.algorithms.build_table_mem_efficient' */
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__Pyx_memviewslice, int, __Pyx_memviewslice, int, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params); /*proto*/
static double __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__Pyx_memviewslice, int, int, int, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params); /*proto*/
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__Pyx_memviewslice, int, __Pyx_memviewslice, int, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params); /*proto*/
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_backward_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, __Pyx_memviewslice, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static __Pyx_memviewslice __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_9radiotool_10algorithms_25build_table_mem_efficient_build_table *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "radiotool.algorithms.build_table_mem_efficient"
int __pyx_module_is_main_radiotool__algorithms__build_table_mem_efficient = 0;

/* Implementation of 'radiotool.algorithms.build_table_mem_efficient' */
...
static PyObject *__pyx_pf_9radiotool_10algorithms_25build_table_mem_efficient_build_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, int __pyx_v_min_beats, int __pyx_v_max_beats, int __pyx_v_first_pause); /* proto */
...
/* "radiotool/algorithms/build_table_mem_efficient.pyx":20
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__Pyx_memviewslice __pyx_v_tc, int __pyx_v_column, __Pyx_memviewslice __pyx_v_tc_column, int __pyx_v_backward, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p) {
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":21
 * 
 * cdef void get_tc_column(double[:, :] tc, int column, double[:] tc_column, int backward, Params p):
 *     cdef int tc_index = 0             # <<<<<<<<<<<<<<
 *     cdef int beat_seg_i = 0
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":22
 * cdef void get_tc_column(double[:, :] tc, int column, double[:] tc_column, int backward, Params p):
 *     cdef int tc_index = 0
 *     cdef int beat_seg_i = 0             # <<<<<<<<<<<<<<
 *     cdef int i, j
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":25
 *     cdef int i, j
 * 
 *     if column >= p.p0_full:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":26
 * 
 *     if column >= p.p0_full:
 *         tc_index = p.p0 + (column - p.p0_full)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":28
 *         tc_index = p.p0 + (column - p.p0_full)
 *     else:
 *         tc_index = column % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":30
 *         tc_index = column % p.n_beats
 * 
 *     if not backward:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":31
 * 
 *     if not backward:
 *         for i in range(p.max_beats_with_padding):             # <<<<<<<<<<<<<<
 *             for j in range(p.p0):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":32
 *     if not backward:
 *         for i in range(p.max_beats_with_padding):
 *             for j in range(p.p0):             # <<<<<<<<<<<<<<
 *                 tc_column[i * p.n_beats + j] = tc[j, tc_index]
 ...
 */
      ...
      for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":33
 *         for i in range(p.max_beats_with_padding):
 *             for j in range(p.p0):
 *                 tc_column[i * p.n_beats + j] = tc[j, tc_index]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":35
 *                 tc_column[i * p.n_beats + j] = tc[j, tc_index]
 * 
 *         for i in range(p.p0_full, p.all_full):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = __pyx_v_p.p0_full; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":36
 * 
 *         for i in range(p.p0_full, p.all_full):
 *             tc_column[i] = tc[p.p0 + i - p.p0_full, tc_index]             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":38
 *             tc_column[i] = tc[p.p0 + i - p.p0_full, tc_index]
 *     else:
 *         for i in range(p.max_beats_with_padding):             # <<<<<<<<<<<<<<
 *             for j in range(p.p0):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":39
 *     else:
 *         for i in range(p.max_beats_with_padding):
 *             for j in range(p.p0):             # <<<<<<<<<<<<<<
 *                 tc_column[i * p.n_beats + j] = tc[tc_index, j]
 ...
 */
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":40
 *         for i in range(p.max_beats_with_padding):
 *             for j in range(p.p0):
 *                 tc_column[i * p.n_beats + j] = tc[tc_index, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":42
 *                 tc_column[i * p.n_beats + j] = tc[tc_index, j]
 * 
 *         for i in range(p.p0_full, p.all_full):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = __pyx_v_p.p0_full; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":43
 * 
 *         for i in range(p.p0_full, p.all_full):
 *             tc_column[i] = tc[tc_index, p.p0 + i - p.p0_full]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":47
 *     #--- CONSTRAINTS ---#
 ...
 */
  ...
  if (__pyx_t_18) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":48
 *     # * don't go to pause before minimum length music segment
 *     if (column == p.p0_full) and (not backward):
 *         for i in range(p.n_beats * p.min_beats):             # <<<<<<<<<<<<<<
 *             tc_column[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":49
 *     if (column == p.p0_full) and (not backward):
 *         for i in range(p.n_beats * p.min_beats):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 *     elif (column < p.n_beats * p.min_beats) and backward:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":50
 *         for i in range(p.n_beats * p.min_beats):
 *             tc_column[i] += p.pen_val
 *     elif (column < p.n_beats * p.min_beats) and backward:             # <<<<<<<<<<<<<<
 *         tc_column[p.p0_full] += p.pen_val
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":51
 *             tc_column[i] += p.pen_val
 *     elif (column < p.n_beats * p.min_beats) and backward:
 *         tc_column[p.p0_full] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":54
 * 
 *     # * don't go to pause after maximum length music segment
 *     if (column == p.p0_full) and (not backward):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_17) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":55
 *     # * don't go to pause after maximum length music segment
 *     if (column == p.p0_full) and (not backward):
 *         for i in range(p.n_beats * p.max_beats, p.p0_full):             # <<<<<<<<<<<<<<
 *             tc_column[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_19 = (__pyx_v_p.n_beats * __pyx_v_p.max_beats); __pyx_t_19 < __pyx_t_3; __pyx_t_19+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":56
 *     if (column == p.p0_full) and (not backward):
 *         for i in range(p.n_beats * p.max_beats, p.p0_full):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 *     elif (p.p0_full > column >= p.n_beats * p.max_beats) and backward:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":57
 *         for i in range(p.n_beats * p.max_beats, p.p0_full):
 *             tc_column[i] += p.pen_val
 *     elif (p.p0_full > column >= p.n_beats * p.max_beats) and backward:             # <<<<<<<<<<<<<<
 *         tc_column[p.p0_full] += p.pen_val
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":58
 *             tc_column[i] += p.pen_val
 *     elif (p.p0_full > column >= p.n_beats * p.max_beats) and backward:
 *         tc_column[p.p0_full] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":61
 * 
 *     # * after pause, don't go to non-first segment beat
 ...
 */
  ...
  if (__pyx_t_18) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":62
 *     # * after pause, don't go to non-first segment beat
 *     if (p.n_beats <= column < p.p0_full) and (not backward):
 *         for i in range(p.p0_full, p.all_full):             # <<<<<<<<<<<<<<
 *             tc_column[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_21 = __pyx_v_p.p0_full; __pyx_t_21 < __pyx_t_19; __pyx_t_21+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":63
 *     if (p.n_beats <= column < p.p0_full) and (not backward):
 *         for i in range(p.p0_full, p.all_full):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 *     elif (column >= p.p0_full) and backward:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":64
 *         for i in range(p.p0_full, p.all_full):
 *             tc_column[i] += p.pen_val
 *     elif (column >= p.p0_full) and backward:             # <<<<<<<<<<<<<<
 *         for i in range(p.n_beats, p.p0_full):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":65
 *             tc_column[i] += p.pen_val
 *     elif (column >= p.p0_full) and backward:
 *         for i in range(p.n_beats, p.p0_full):             # <<<<<<<<<<<<<<
 *             tc_column[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_21 = __pyx_v_p.n_beats; __pyx_t_21 < __pyx_t_19; __pyx_t_21+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":66
 *     elif (column >= p.p0_full) and backward:
 *         for i in range(p.n_beats, p.p0_full):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":69
 * 
 *     # * don't move between beats the don't follow segment index
 *     if column < p.p0_full:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":70
 *     # * don't move between beats the don't follow segment index
 *     if column < p.p0_full:
 *         for i in range(p.p0_full):             # <<<<<<<<<<<<<<
 *             tc_column[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_19; __pyx_t_21+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":71
 *     if column < p.p0_full:
 *         for i in range(p.p0_full):
 *             tc_column[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":73
 *             tc_column[i] += p.pen_val
 * 
 *         beat_seg_i = column / p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":75
 *         beat_seg_i = column / p.n_beats
 * 
 *         if (beat_seg_i > 0) and (not backward):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_17) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":76
 * 
 *         if (beat_seg_i > 0) and (not backward):
 *             for i in range((beat_seg_i - 1) * p.n_beats, beat_seg_i * p.n_beats):             # <<<<<<<<<<<<<<
 *                 tc_column[i] -= p.pen_val
 ...
 */
      ...
      for (__pyx_t_21 = ((__pyx_v_beat_seg_i - 1) * __pyx_v_p.n_beats); __pyx_t_21 < __pyx_t_19; __pyx_t_21+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":77
 *         if (beat_seg_i > 0) and (not backward):
 *             for i in range((beat_seg_i - 1) * p.n_beats, beat_seg_i * p.n_beats):
 *                 tc_column[i] -= p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":79
 *                 tc_column[i] -= p.pen_val
 * 
 *         elif (beat_seg_i < p.max_beats_with_padding - 1) and backward:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":80
 * 
 *         elif (beat_seg_i < p.max_beats_with_padding - 1) and backward:
 *             for i in range((beat_seg_i + 1) * p.n_beats, (beat_seg_i + 2) * p.n_beats):             # <<<<<<<<<<<<<<
 *                 tc_column[i] -= p.pen_val
 ...
 */
      ...
      for (__pyx_t_19 = ((__pyx_v_beat_seg_i + 1) * __pyx_v_p.n_beats); __pyx_t_19 < __pyx_t_27; __pyx_t_19+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":81
 *         elif (beat_seg_i < p.max_beats_with_padding - 1) and backward:
 *             for i in range((beat_seg_i + 1) * p.n_beats, (beat_seg_i + 2) * p.n_beats):
 *                 tc_column[i] -= p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":85
 *         # you're also allowed to move infinitely among the
 ...
 */
    ...
    if (__pyx_t_18) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":86
 *         # last beat if max_beats is not set (== -1)
 *         if p.max_beats == -1 and (beat_seg_i == p.min_beats):
 *             for i in range(beat_seg_i * p.n_beats, (beat_seg_i + 1) * p.n_beats):             # <<<<<<<<<<<<<<
 *                 tc_column[i] -= p.pen_val
 ...
 */
      ...
      for (__pyx_t_19 = (__pyx_v_beat_seg_i * __pyx_v_p.n_beats); __pyx_t_19 < __pyx_t_27; __pyx_t_19+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":87
 *         if p.max_beats == -1 and (beat_seg_i == p.min_beats):
 *             for i in range(beat_seg_i * p.n_beats, (beat_seg_i + 1) * p.n_beats):
 *                 tc_column[i] -= p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.get_tc_column", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "radiotool/algorithms/build_table_mem_efficient.pyx":90
 * 
 * 
...
static double __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__Pyx_memviewslice __pyx_v_pen, int __pyx_v_i, int __pyx_v_l, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p) {
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":91
 * 
 * cdef double get_pen_value(double[:, :] pen, int i, int l, int global_start_l, Params p):
 *     cdef int pen_index = 0             # <<<<<<<<<<<<<<
 *     if i >= p.p0_full:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":92
 * cdef double get_pen_value(double[:, :] pen, int i, int l, int global_start_l, Params p):
 *     cdef int pen_index = 0
 *     if i >= p.p0_full:             # <<<<<<<<<<<<<<
 *         pen_index = p.n_beats + (i - p.p0_full)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":93
 *     cdef int pen_index = 0
 *     if i >= p.p0_full:
 *         pen_index = p.n_beats + (i - p.p0_full)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":95
 *         pen_index = p.n_beats + (i - p.p0_full)
 *     else:
 *         pen_index = i % p.n_beats             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":96
 *     else:
 *         pen_index = i % p.n_beats
 *     cdef double new_pen = pen[pen_index, l]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":100
 *     #--- CONSTRAINTS ---#
 ...
 */
  ...
  if (__pyx_t_6) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":101
 *     # * don't start song in segment beat other than first
 *     if global_start_l == 0 and (p.n_beats <= i < p.p0_full):
 *         new_pen += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":103
 *         new_pen += p.pen_val
 * 
 *     return new_pen             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.get_pen_value", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "radiotool/algorithms/build_table_mem_efficient.pyx":105
 *     return new_pen
 * 
 * cdef void get_pen_column(double[:, :] pen, int column, double[:] new_pen, int global_start_l, Params p):             # <<<<<<<<<<<<<<
 *     cdef int i, j
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__Pyx_memviewslice __pyx_v_pen, int __pyx_v_column, __Pyx_memviewslice __pyx_v_new_pen, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p) {
  int __pyx_v_i;
  int __pyx_v_j;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":108
 *     cdef int i, j
 * 
 *     for i in range(p.max_beats_with_padding):             # <<<<<<<<<<<<<<
 *         for j in range(p.p0):
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":109
 * 
 *     for i in range(p.max_beats_with_padding):
 *         for j in range(p.p0):             # <<<<<<<<<<<<<<
 *             new_pen[i * p.n_beats + j] = pen[j, column]
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":110
 *     for i in range(p.max_beats_with_padding):
 *         for j in range(p.p0):
 *             new_pen[i * p.n_beats + j] = pen[j, column]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":112
 *             new_pen[i * p.n_beats + j] = pen[j, column]
 * 
 *     for i in range(p.p0_full, p.all_full):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_2 = __pyx_v_p.p0_full; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":113
 * 
 *     for i in range(p.p0_full, p.all_full):
 *         new_pen[i] = pen[p.p0 + i - p.p0_full, column]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":117
 *     #--- CONSTRAINTS ---#
 *     # * don't start song in segment beat other than first
 *     if global_start_l == 0:             # <<<<<<<<<<<<<<
 *         for i in range(p.n_beats, p.p0_full):
 ...
 */
  ...
  if (__pyx_t_10) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":118
 *     # * don't start song in segment beat other than first
 *     if global_start_l == 0:
 *         for i in range(p.n_beats, p.p0_full):             # <<<<<<<<<<<<<<
 *             new_pen[i] += p.pen_val
 ...
 */
    ...
    for (__pyx_t_2 = __pyx_v_p.n_beats; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":119
 *     if global_start_l == 0:
 *         for i in range(p.n_beats, p.p0_full):
 *             new_pen[i] += p.pen_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.get_pen_column", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "radiotool/algorithms/build_table_mem_efficient.pyx":122
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_pen_val, __Pyx_memviewslice __pyx_v_vals_col, __Pyx_memviewslice __pyx_v_min_vals) {
  int __pyx_v_l;
  int __pyx_v_idx;
  int __pyx_v_i;
  int __pyx_v_beat_seg_i;
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":130
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":131
 *     # generate initial cost
 *     if start_beat != -1:
 *         cost[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *         cost[start_beat] = get_pen_value(pen, start_beat, 0, global_start_l, p)
...

{
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":132
 *     if start_beat != -1:
 *         cost[:] = 99999999  # N.inf
 *         cost[start_beat] = get_pen_value(pen, start_beat, 0, global_start_l, p)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    if (__pyx_t_3 < 0) {
      __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_3 >= __pyx_v_cost.shape[0])) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 132; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_3 * __pyx_v_cost.strides[0]) )) = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__pyx_v_pen, __pyx_v_start_beat, 0, __pyx_v_global_start_l, __pyx_v_p);
    goto __pyx_L3;
  }
  /*else*/ {

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":134
 *         cost[start_beat] = get_pen_value(pen, start_beat, 0, global_start_l, p)
 *     else:
 *         get_pen_column(pen, 0, cost, global_start_l, p)             # <<<<<<<<<<<<<<
 * 
 *     # optimize
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__pyx_v_pen, 0, __pyx_v_cost, __pyx_v_global_start_l, __pyx_v_p);
  }
  __pyx_L3:;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":137
 * 
 *     # optimize
 ...
 *             # handle end beat set
 */
  __pyx_t_5 = (__pyx_v_pen.shape[1]);
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_5; __pyx_t_4+=1) {
    __pyx_v_l = __pyx_t_4;

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":138
 *     # optimize
 *     for l in range(1, pen.shape[1]):
 *         if l == pen.shape[1] - 1 and end_beat != -1:             # <<<<<<<<<<<<<<
 *             # handle end beat set
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":140
 *         if l == pen.shape[1] - 1 and end_beat != -1:
 *             # handle end beat set
 *             end_pen = get_pen_value(pen, end_beat, l, global_start_l + l, p)             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_v_end_pen = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__pyx_v_pen, __pyx_v_end_beat, __pyx_v_l, (__pyx_v_global_start_l + __pyx_v_l), __pyx_v_p);

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":141
 *             # handle end beat set
 *             end_pen = get_pen_value(pen, end_beat, l, global_start_l + l, p)
 *             get_tc_column(tc, end_beat, vals_col, 0, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__pyx_v_tc, __pyx_v_end_beat, __pyx_v_vals_col, 0, __pyx_v_p);

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":143
 *             get_tc_column(tc, end_beat, vals_col, 0, p)
 * 
 *             min_vals[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *             minval = -1
...

{
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":144
 * 
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1             # <<<<<<<<<<<<<<
 *             for i in range(vals_col.shape[0]):
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":145
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1
 *             for i in range(vals_col.shape[0]):             # <<<<<<<<<<<<<<
 *                 if minval == -1 or vals_col[i] + cost[i] + end_pen < minval:
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":146
 *             minval = -1
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + end_pen < minval:             # <<<<<<<<<<<<<<
 *                     minval = vals_col[i] + cost[i] + end_pen
 ...
 */
        ...
        if (!__pyx_t_7) {
          ...
          if (__pyx_t_11 < 0) {
            __pyx_t_12 = 0;
          } else if (unlikely(__pyx_t_11 >= __pyx_v_vals_col.shape[0])) __pyx_t_12 = 0;
          ...
          if (__pyx_t_12 < 0) {
            __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_12 >= __pyx_v_cost.shape[0])) __pyx_t_13 = 0;
        ...
        if (__pyx_t_6) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":147
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + end_pen < minval:
 *                     minval = vals_col[i] + cost[i] + end_pen             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          if (__pyx_t_13 < 0) {
            __pyx_t_14 = 0;
          } else if (unlikely(__pyx_t_13 >= __pyx_v_vals_col.shape[0])) __pyx_t_14 = 0;
          if (unlikely(__pyx_t_14 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_14);
          ...
          if (__pyx_t_14 < 0) {
            __pyx_t_15 = 0;
          } else if (unlikely(__pyx_t_14 >= __pyx_v_cost.shape[0])) __pyx_t_15 = 0;
          if (unlikely(__pyx_t_15 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_15);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 147; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":149
 *                     minval = vals_col[i] + cost[i] + end_pen
 * 
 *             min_vals[end_beat] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_9 < 0) {
        __pyx_t_15 = 0;
      } else if (unlikely(__pyx_t_9 >= __pyx_v_min_vals.shape[0])) __pyx_t_15 = 0;
      if (unlikely(__pyx_t_15 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_15);
    ...
    /*else*/ {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":152
 * 
 *         else:
 ...
 */
      __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__pyx_v_pen, __pyx_v_l, __pyx_v_pen_val, (__pyx_v_global_start_l + __pyx_v_l), __pyx_v_p);

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":167
 * 
 *             # first beat segment
 ...
 */
      ...
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":169
 *             for idx in range(p.n_beats):
 *                 # could only get here from the last pause beat
 *                 min_vals[idx] = tc[p.n_beats + p.n_pauses - 1, idx] + pen_val[idx] + cost[p.all_full - 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_17 < 0) {
          __pyx_t_19 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_tc.shape[0])) __pyx_t_19 = 0;
        if (__pyx_t_18 < 0) {
          __pyx_t_19 = 1;
        } else if (unlikely(__pyx_t_18 >= __pyx_v_tc.shape[1])) __pyx_t_19 = 1;
        if (unlikely(__pyx_t_19 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_19);
        ...
        if (__pyx_t_19 < 0) {
          __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_19 >= __pyx_v_pen_val.shape[0])) __pyx_t_20 = 0;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_21 = (__pyx_v_p.all_full - 1);
        __pyx_t_20 = -1;
        if (__pyx_t_21 < 0) {
          __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_cost.shape[0])) __pyx_t_20 = 0;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        if (__pyx_t_20 < 0) {
          __pyx_t_22 = 0;
        } else if (unlikely(__pyx_t_20 >= __pyx_v_min_vals.shape[0])) __pyx_t_22 = 0;
        if (unlikely(__pyx_t_22 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_22);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_20 * __pyx_v_min_vals.strides[0]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_17 * __pyx_v_tc.strides[0]) ) + __pyx_t_18 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_19 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_21 * __pyx_v_cost.strides[0]) ))));
      }

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":172
 * 
 *             # all other music beat segments
 ...
 */
      ...
      for (__pyx_t_16 = __pyx_v_p.n_beats; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":173
 *             # all other music beat segments
 *             for idx in range(p.n_beats, p.p0_full):
 *                 beat_seg_i = idx / p.n_beats             # <<<<<<<<<<<<<<
 *                 orig_beat_i = idx % p.n_beats
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":174
 *             for idx in range(p.n_beats, p.p0_full):
 *                 beat_seg_i = idx / p.n_beats
 *                 orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":179
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":180
 *                 # another music beat
 *                 seg_start_beat = (beat_seg_i - 1) * p.n_beats
 *                 minval = -1             # <<<<<<<<<<<<<<
 *                 for j in range(p.n_beats):
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":181
 *                 seg_start_beat = (beat_seg_i - 1) * p.n_beats
 *                 minval = -1
 *                 for j in range(p.n_beats):             # <<<<<<<<<<<<<<
 *                     tmpval = tc[j, orig_beat_i] + pen_val[idx] + cost[seg_start_beat + j]
 ...
 */
        ...
        for (__pyx_t_23 = 0; __pyx_t_23 < __pyx_t_22; __pyx_t_23+=1) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":182
 *                 minval = -1
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[j, orig_beat_i] + pen_val[idx] + cost[seg_start_beat + j]             # <<<<<<<<<<<<<<
 *                     if minval == -1 or tmpval < minval:
 ...
 */
          ...
          if (__pyx_t_24 < 0) {
            __pyx_t_26 = 0;
          } else if (unlikely(__pyx_t_24 >= __pyx_v_tc.shape[0])) __pyx_t_26 = 0;
          if (__pyx_t_25 < 0) {
            __pyx_t_26 = 1;
          } else if (unlikely(__pyx_t_25 >= __pyx_v_tc.shape[1])) __pyx_t_26 = 1;
          if (unlikely(__pyx_t_26 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_26);
          ...
          if (__pyx_t_26 < 0) {
            __pyx_t_27 = 0;
          } else if (unlikely(__pyx_t_26 >= __pyx_v_pen_val.shape[0])) __pyx_t_27 = 0;
          ...
          if (__pyx_t_27 < 0) {
            __pyx_t_28 = 0;
          } else if (unlikely(__pyx_t_27 >= __pyx_v_cost.shape[0])) __pyx_t_28 = 0;
          if (unlikely(__pyx_t_28 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_28);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":183
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[j, orig_beat_i] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                         minval = tmpval
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":184
 *                     tmpval = tc[j, orig_beat_i] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":186
 *                         minval = tmpval
 * 
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_22 < 0) {
          __pyx_t_23 = 0;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_min_vals.shape[0])) __pyx_t_23 = 0;
        if (unlikely(__pyx_t_23 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_23);
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":191
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":192
 *             # min beat <= beat seg <= max beat
 *             minval = -1
 *             for full_j in range(p.n_beats * (p.min_beats - 1), p.n_beats * p.max_beats):             # <<<<<<<<<<<<<<
 *                 orig_beat_j = full_j % p.n_beats
 ...
 */
      ...
      for (__pyx_t_16 = (__pyx_v_p.n_beats * (__pyx_v_p.min_beats - 1)); __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":193
 *             minval = -1
 *             for full_j in range(p.n_beats * (p.min_beats - 1), p.n_beats * p.max_beats):
 *                 orig_beat_j = full_j % p.n_beats             # <<<<<<<<<<<<<<
 *                 tmpval = tc[orig_beat_j, p.p0] + pen_val[p.p0_full] + cost[full_j]
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":194
 *             for full_j in range(p.n_beats * (p.min_beats - 1), p.n_beats * p.max_beats):
 *                 orig_beat_j = full_j % p.n_beats
 *                 tmpval = tc[orig_beat_j, p.p0] + pen_val[p.p0_full] + cost[full_j]             # <<<<<<<<<<<<<<
 *                 if minval == -1 or tmpval < minval:
 ...
 */
        ...
        if (__pyx_t_23 < 0) {
          __pyx_t_29 = 0;
        } else if (unlikely(__pyx_t_23 >= __pyx_v_tc.shape[0])) __pyx_t_29 = 0;
        if (__pyx_t_28 < 0) {
          __pyx_t_29 = 1;
        } else if (unlikely(__pyx_t_28 >= __pyx_v_tc.shape[1])) __pyx_t_29 = 1;
        ...
        if (__pyx_t_29 < 0) {
          __pyx_t_30 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_v_pen_val.shape[0])) __pyx_t_30 = 0;
        ...
        if (__pyx_t_30 < 0) {
          __pyx_t_31 = 0;
        } else if (unlikely(__pyx_t_30 >= __pyx_v_cost.shape[0])) __pyx_t_31 = 0;
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":195
 *                 orig_beat_j = full_j % p.n_beats
 *                 tmpval = tc[orig_beat_j, p.p0] + pen_val[p.p0_full] + cost[full_j]
 *                 if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                     minval = tmpval
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":196
 *                 tmpval = tc[orig_beat_j, p.p0] + pen_val[p.p0_full] + cost[full_j]
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval             # <<<<<<<<<<<<<<
 *             min_vals[p.p0_full] = minval
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":197
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval
 *             min_vals[p.p0_full] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_15 < 0) {
        __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_min_vals.shape[0])) __pyx_t_16 = 0;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_15 * __pyx_v_min_vals.strides[0]) )) = __pyx_v_minval;
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":200
 * 
 *             # other pause beat
 ...
 */
      ...
      for (__pyx_t_31 = (__pyx_v_p.p0_full + 1); __pyx_t_31 < __pyx_t_16; __pyx_t_31+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":201
 *             # other pause beat
 *             for idx in range(p.p0_full + 1, p.all_full):
 *                 orig_beat_i = p.p0 + (idx - p.p0_full)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":204
 * 
 *                 # must have gotten here from another pause beat
 *                 minval = -1             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":205
 *                 # must have gotten here from another pause beat
 *                 minval = -1
 *                 for j in range(p.n_pauses):             # <<<<<<<<<<<<<<
 *                     tmpval = tc[p.p0 + j, orig_beat_i] + pen_val[idx] + cost[p.p0_full + j]
 ...
 */
        ...
        for (__pyx_t_33 = 0; __pyx_t_33 < __pyx_t_32; __pyx_t_33+=1) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":206
 *                 minval = -1
 *                 for j in range(p.n_pauses):
 *                     tmpval = tc[p.p0 + j, orig_beat_i] + pen_val[idx] + cost[p.p0_full + j]             # <<<<<<<<<<<<<<
 *                     if minval == -1 or tmpval < minval:
 ...
 */
          ...
          if (__pyx_t_34 < 0) {
            __pyx_t_36 = 0;
          } else if (unlikely(__pyx_t_34 >= __pyx_v_tc.shape[0])) __pyx_t_36 = 0;
          if (__pyx_t_35 < 0) {
            __pyx_t_36 = 1;
          } else if (unlikely(__pyx_t_35 >= __pyx_v_tc.shape[1])) __pyx_t_36 = 1;
          ...
          if (__pyx_t_36 < 0) {
            __pyx_t_37 = 0;
          } else if (unlikely(__pyx_t_36 >= __pyx_v_pen_val.shape[0])) __pyx_t_37 = 0;
          ...
          if (__pyx_t_37 < 0) {
            __pyx_t_38 = 0;
          } else if (unlikely(__pyx_t_37 >= __pyx_v_cost.shape[0])) __pyx_t_38 = 0;
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":207
 *                 for j in range(p.n_pauses):
 *                     tmpval = tc[p.p0 + j, orig_beat_i] + pen_val[idx] + cost[p.p0_full + j]
 *                     if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                         minval = tmpval
 ...
 */
          ...
          if (__pyx_t_6) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":208
 *                     tmpval = tc[p.p0 + j, orig_beat_i] + pen_val[idx] + cost[p.p0_full + j]
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval             # <<<<<<<<<<<<<<
 *                 min_vals[idx] = minval
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":209
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_32 < 0) {
          __pyx_t_33 = 0;
        } else if (unlikely(__pyx_t_32 >= __pyx_v_min_vals.shape[0])) __pyx_t_33 = 0;
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":211
 *                 min_vals[idx] = minval
 * 
 *         cost[:] = min_vals             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_16 = -1;
    __pyx_t_39.data = __pyx_v_cost.data;
    __pyx_t_39.memview = __pyx_v_cost.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_39, 0);
    __pyx_t_39.shape[0] = __pyx_v_cost.shape[0];
__pyx_t_39.strides[0] = __pyx_v_cost.strides[0];
    __pyx_t_39.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_min_vals, __pyx_t_39, 1, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_39, 1);
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.space_efficient_cost_with_duration_constraint", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "radiotool/algorithms/build_table_mem_efficient.pyx":214
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_backward_space_efficient_cost_with_duration_constraint(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_global_start_l, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_pen_val, __Pyx_memviewslice __pyx_v_vals_col, __Pyx_memviewslice __pyx_v_min_vals) {
  int __pyx_v_l;
  int __pyx_v_idx;
  int __pyx_v_i;
  int __pyx_v_beat_seg_i;
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":222
 * 
 *     # generate initial cost
 *     if end_beat != -1:             # <<<<<<<<<<<<<<
 *         cost[:] = 99999999  # N.inf
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":223
 *     # generate initial cost
 *     if end_beat != -1:
 *         cost[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)
...

{
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":224
 *     if end_beat != -1:
 *         cost[:] = 99999999  # N.inf
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_3 * __pyx_v_cost.strides[0]) )) = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__pyx_v_pen, __pyx_v_end_beat, ((__pyx_v_pen.shape[1]) - 1), ((__pyx_v_global_start_l + (__pyx_v_pen.shape[1])) - 1), __pyx_v_p);
    goto __pyx_L3;
  }
  /*else*/ {

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":226
 *         cost[end_beat] = get_pen_value(pen, end_beat, pen.shape[1] - 1, global_start_l + pen.shape[1] - 1, p)
 *     else:
 *         get_pen_column(pen, pen.shape[1] - 1, cost, global_start_l + pen.shape[1] - 1, p)             # <<<<<<<<<<<<<<
 * 
 *     # optimize
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__pyx_v_pen, ((__pyx_v_pen.shape[1]) - 1), __pyx_v_cost, ((__pyx_v_global_start_l + (__pyx_v_pen.shape[1])) - 1), __pyx_v_p);
  }
  __pyx_L3:;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":229
 * 
 *     # optimize
 ...
 */
  ...
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_5; __pyx_t_4+=1) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":230
 *     # optimize
 *     for l in xrange(1, pen.shape[1]):
 *         if l == 0 and start_beat != -1:             # <<<<<<<<<<<<<<
 *             # handle start beat set
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":232
 *         if l == 0 and start_beat != -1:
 *             # handle start beat set
 *             start_pen = get_pen_value(pen, start_beat, l, global_start_l + l, p)             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_v_start_pen = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_value(__pyx_v_pen, __pyx_v_start_beat, __pyx_v_l, (__pyx_v_global_start_l + __pyx_v_l), __pyx_v_p);

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":233
 *             # handle start beat set
 *             start_pen = get_pen_value(pen, start_beat, l, global_start_l + l, p)
 *             get_tc_column(tc, start_beat, vals_col, 1, p)             # <<<<<<<<<<<<<<
 * 
 *             min_vals[:] = 99999999  # N.inf
 */
      __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__pyx_v_tc, __pyx_v_start_beat, __pyx_v_vals_col, 1, __pyx_v_p);

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":235
 *             get_tc_column(tc, start_beat, vals_col, 1, p)
 * 
 *             min_vals[:] = 99999999  # N.inf             # <<<<<<<<<<<<<<
 *             minval = -1
...

{
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":236
 * 
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1             # <<<<<<<<<<<<<<
 *             for i in range(vals_col.shape[0]):
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":237
 *             min_vals[:] = 99999999  # N.inf
 *             minval = -1
 *             for i in range(vals_col.shape[0]):             # <<<<<<<<<<<<<<
 *                 if minval == -1 or vals_col[i] + cost[i] + start_pen < minval:
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":238
 *             minval = -1
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + start_pen < minval:             # <<<<<<<<<<<<<<
 *                     minval = vals_col[i] + cost[i] + start_pen
 ...
 */
        ...
        if (!__pyx_t_7) {
          ...
          __pyx_t_1 = (((((*((double *) ( /* dim=0 */ (__pyx_v_vals_col.data + __pyx_t_11 * __pyx_v_vals_col.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_12 * __pyx_v_cost.strides[0]) )))) + __pyx_v_start_pen) < __pyx_v_minval) != 0);
          __pyx_t_6 = __pyx_t_1;
        } else {
          __pyx_t_6 = __pyx_t_7;
        }
        if (__pyx_t_6) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":239
 *             for i in range(vals_col.shape[0]):
 *                 if minval == -1 or vals_col[i] + cost[i] + start_pen < minval:
 *                     minval = vals_col[i] + cost[i] + start_pen             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          __pyx_v_minval = (((*((double *) ( /* dim=0 */ (__pyx_v_vals_col.data + __pyx_t_13 * __pyx_v_vals_col.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_14 * __pyx_v_cost.strides[0]) )))) + __pyx_v_start_pen);
          goto __pyx_L9;
        }
        __pyx_L9:;
      }

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":241
 *                     minval = vals_col[i] + cost[i] + start_pen
 * 
 *             min_vals[start_beat] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /*else*/ {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":244
 * 
 *         else:
 *             get_pen_column(pen, l, pen_val, global_start_l + l, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":249
 * 
 ...
 *                 orig_beat_i = idx % p.n_beats
 */
      __pyx_t_16 = (__pyx_v_p.n_beats * (__pyx_v_p.min_beats - 1));
      for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_16; __pyx_t_15+=1) {
        __pyx_v_idx = __pyx_t_15;

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":250
 *             # beat segment before min_beat
 *             for idx in range(p.n_beats * (p.min_beats - 1)):
 *                 beat_seg_i = idx / p.n_beats             # <<<<<<<<<<<<<<
 *                 orig_beat_i = idx % p.n_beats
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":251
 *             for idx in range(p.n_beats * (p.min_beats - 1)):
 *                 beat_seg_i = idx / p.n_beats
 *                 orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":254
 * 
 *                 # could only be going to beat_seg_i + 1
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats             # <<<<<<<<<<<<<<
 *                 minval = -1
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":255
 *                 # could only be going to beat_seg_i + 1
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats
 *                 minval = -1             # <<<<<<<<<<<<<<
 *                 for j in range(p.n_beats):
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":256
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats
 *                 minval = -1
 *                 for j in range(p.n_beats):             # <<<<<<<<<<<<<<
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 ...
 */
        ...
        for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=1) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":257
 *                 minval = -1
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]             # <<<<<<<<<<<<<<
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval
 */
          __pyx_t_19 = __pyx_v_orig_beat_i;
          __pyx_t_20 = __pyx_v_j;
          __pyx_t_21 = -1;
          if (__pyx_t_19 < 0) {
            __pyx_t_21 = 0;
          } else if (unlikely(__pyx_t_19 >= __pyx_v_tc.shape[0])) __pyx_t_21 = 0;
          if (__pyx_t_20 < 0) {
            __pyx_t_21 = 1;
          } else if (unlikely(__pyx_t_20 >= __pyx_v_tc.shape[1])) __pyx_t_21 = 1;
          if (unlikely(__pyx_t_21 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_21);
          ...
          if (__pyx_t_21 < 0) {
            __pyx_t_22 = 0;
          } else if (unlikely(__pyx_t_21 >= __pyx_v_pen_val.shape[0])) __pyx_t_22 = 0;
          if (unlikely(__pyx_t_22 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_22);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 257; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
          __pyx_t_22 = (__pyx_v_seg_start_beat + __pyx_v_j);
          __pyx_t_23 = -1;
          if (__pyx_t_22 < 0) {
            __pyx_t_23 = 0;
          ...
          __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_19 * __pyx_v_tc.strides[0]) ) + __pyx_t_20 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_21 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_22 * __pyx_v_cost.strides[0]) ))));

          /* "radiotool/algorithms/build_table_mem_efficient.pyx":258
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                         minval = tmpval
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":259
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":261
 *                         minval = tmpval
 * 
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_17 < 0) {
          __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_min_vals.shape[0])) __pyx_t_18 = 0;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 261; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_17 * __pyx_v_min_vals.strides[0]) )) = __pyx_v_minval;
      }

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":264
 * 
 *             # beat segment between min beat and max beat
 ...
 *                 orig_beat_i = idx % p.n_beats
 */
      __pyx_t_16 = (__pyx_v_p.n_beats * (__pyx_v_p.max_beats - 1));
      for (__pyx_t_15 = (__pyx_v_p.n_beats * (__pyx_v_p.min_beats - 1)); __pyx_t_15 < __pyx_t_16; __pyx_t_15+=1) {
        __pyx_v_idx = __pyx_t_15;

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":265
 *             # beat segment between min beat and max beat
 *             for idx in range(p.n_beats * (p.min_beats - 1), p.n_beats * (p.max_beats - 1)):
 *                 beat_seg_i = idx / p.n_beats             # <<<<<<<<<<<<<<
 *                 orig_beat_i = idx % p.n_beats
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":266
 *             for idx in range(p.n_beats * (p.min_beats - 1), p.n_beats * (p.max_beats - 1)):
 *                 beat_seg_i = idx / p.n_beats
 *                 orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":269
 * 
 *                 # could be going to beat_seg_i + 1
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats             # <<<<<<<<<<<<<<
 *                 minval = -1
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":270
 *                 # could be going to beat_seg_i + 1
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats
 *                 minval = -1             # <<<<<<<<<<<<<<
 *                 for j in range(p.n_beats):
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":271
 *                 seg_start_beat = (beat_seg_i + 1) * p.n_beats
 *                 minval = -1
 *                 for j in range(p.n_beats):             # <<<<<<<<<<<<<<
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:
 */
        __pyx_t_18 = __pyx_v_p.n_beats;
        for (__pyx_t_23 = 0; __pyx_t_23 < __pyx_t_18; __pyx_t_23+=1) {
          __pyx_v_j = __pyx_t_23;

          /* "radiotool/algorithms/build_table_mem_efficient.pyx":272
 *                 minval = -1
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]             # <<<<<<<<<<<<<<
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval
 */
          __pyx_t_24 = __pyx_v_orig_beat_i;
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":273
 *                 for j in range(p.n_beats):
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                         minval = tmpval
 ...
 */
          ...
          if (__pyx_t_7) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":274
 *                     tmpval = tc[orig_beat_i, j] + pen_val[idx] + cost[seg_start_beat + j]
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval             # <<<<<<<<<<<<<<
 *                 # or could be going to first pause beat
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":276
 *                         minval = tmpval
 *                 # or could be going to first pause beat
 *                 tmpval = tc[orig_beat_i, p.p0] + pen_val[idx] + cost[p.p0_full]             # <<<<<<<<<<<<<<
 *                 if minval == -1 or tmpval < minval:
 ...
 */
        ...
        __pyx_t_23 = __pyx_v_p.p0;
        __pyx_t_28 = -1;
        if (__pyx_t_18 < 0) {
          __pyx_t_28 = 0;
        } else if (unlikely(__pyx_t_18 >= __pyx_v_tc.shape[0])) __pyx_t_28 = 0;
        if (__pyx_t_23 < 0) {
          __pyx_t_28 = 1;
        } else if (unlikely(__pyx_t_23 >= __pyx_v_tc.shape[1])) __pyx_t_28 = 1;
        if (unlikely(__pyx_t_28 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_28);
        ...
        if (__pyx_t_28 < 0) {
          __pyx_t_29 = 0;
        } else if (unlikely(__pyx_t_28 >= __pyx_v_pen_val.shape[0])) __pyx_t_29 = 0;
        if (unlikely(__pyx_t_29 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_29);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 276; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        if (__pyx_t_29 < 0) {
          __pyx_t_30 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_v_cost.shape[0])) __pyx_t_30 = 0;
        if (unlikely(__pyx_t_30 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_30);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 276; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_18 * __pyx_v_tc.strides[0]) ) + __pyx_t_23 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_28 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_29 * __pyx_v_cost.strides[0]) ))));

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":277
 *                 # or could be going to first pause beat
 *                 tmpval = tc[orig_beat_i, p.p0] + pen_val[idx] + cost[p.p0_full]
 *                 if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                     minval = tmpval
 ...
 */
        ...
        if (__pyx_t_6) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":278
 *                 tmpval = tc[orig_beat_i, p.p0] + pen_val[idx] + cost[p.p0_full]
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":280
 *                     minval = tmpval
 * 
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_30 < 0) {
          __pyx_t_31 = 0;
        } else if (unlikely(__pyx_t_30 >= __pyx_v_min_vals.shape[0])) __pyx_t_31 = 0;
        if (unlikely(__pyx_t_31 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_31);
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":283
 * 
 *             # max beat segment
 ...
 */
      __pyx_t_15 = (__pyx_v_p.n_beats * __pyx_v_p.max_beats);
      for (__pyx_t_31 = (__pyx_v_p.n_beats * (__pyx_v_p.max_beats - 1)); __pyx_t_31 < __pyx_t_15; __pyx_t_31+=1) {
        __pyx_v_idx = __pyx_t_31;

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":284
 *             # max beat segment
 *             for idx in range(p.n_beats * (p.max_beats - 1), p.n_beats * p.max_beats):
 *                 orig_beat_i = idx % p.n_beats             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":287
 * 
 *                 # must be going to first pause beat
 ...
 */
        ...
        if (__pyx_t_35 < 0) {
          __pyx_t_36 = 0;
        } else if (unlikely(__pyx_t_35 >= __pyx_v_cost.shape[0])) __pyx_t_36 = 0;
        if (unlikely(__pyx_t_36 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_36);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 287; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        if (__pyx_t_36 < 0) {
          __pyx_t_37 = 0;
        } else if (unlikely(__pyx_t_36 >= __pyx_v_min_vals.shape[0])) __pyx_t_37 = 0;
        if (unlikely(__pyx_t_37 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_37);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 287; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_36 * __pyx_v_min_vals.strides[0]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_32 * __pyx_v_tc.strides[0]) ) + __pyx_t_33 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_34 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_35 * __pyx_v_cost.strides[0]) ))));
      }

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":290
 * 
 *             # pause beats except the last one
 ...
 * 
 */
      __pyx_t_16 = (__pyx_v_p.all_full - 1);
      for (__pyx_t_15 = __pyx_v_p.p0_full; __pyx_t_15 < __pyx_t_16; __pyx_t_15+=1) {
        __pyx_v_idx = __pyx_t_15;

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":291
 *             # pause beats except the last one
 *             for idx in range(p.p0_full, p.all_full - 1):
 *                 orig_beat_i = p.p0 + (idx - p.p0_full)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":294
 * 
 *                 # could only be going to another pause beat
 *                 minval = -1             # <<<<<<<<<<<<<<
 *                 for j in range(p.n_pauses):
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":295
 *                 # could only be going to another pause beat
 *                 minval = -1
 *                 for j in range(p.n_pauses):             # <<<<<<<<<<<<<<
 *                     tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + cost[p.p0_full + j]
 *                     if minval == -1 or tmpval < minval:
 */
        __pyx_t_31 = __pyx_v_p.n_pauses;
        for (__pyx_t_37 = 0; __pyx_t_37 < __pyx_t_31; __pyx_t_37+=1) {
          __pyx_v_j = __pyx_t_37;

          /* "radiotool/algorithms/build_table_mem_efficient.pyx":296
 *                 minval = -1
 *                 for j in range(p.n_pauses):
 *                     tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + cost[p.p0_full + j]             # <<<<<<<<<<<<<<
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval
 */
          __pyx_t_38 = __pyx_v_orig_beat_i;
          __pyx_t_39 = (__pyx_v_p.p0 + __pyx_v_j);
          __pyx_t_40 = -1;
          if (__pyx_t_38 < 0) {
            __pyx_t_40 = 0;
          } else if (unlikely(__pyx_t_38 >= __pyx_v_tc.shape[0])) __pyx_t_40 = 0;
          if (__pyx_t_39 < 0) {
            __pyx_t_40 = 1;
          ...
          if (__pyx_t_40 < 0) {
            __pyx_t_41 = 0;
          } else if (unlikely(__pyx_t_40 >= __pyx_v_pen_val.shape[0])) __pyx_t_41 = 0;
          if (unlikely(__pyx_t_41 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_41);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 296; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
          __pyx_t_41 = (__pyx_v_p.p0_full + __pyx_v_j);
          __pyx_t_42 = -1;
          if (__pyx_t_41 < 0) {
            __pyx_t_42 = 0;
          } else if (unlikely(__pyx_t_41 >= __pyx_v_cost.shape[0])) __pyx_t_42 = 0;
          if (unlikely(__pyx_t_42 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_42);
            {__pyx_filename = __pyx_f[0]; __pyx_lineno = 296; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          }
          __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_38 * __pyx_v_tc.strides[0]) ) + __pyx_t_39 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_40 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_41 * __pyx_v_cost.strides[0]) ))));

          /* "radiotool/algorithms/build_table_mem_efficient.pyx":297
 *                 for j in range(p.n_pauses):
 *                     tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + cost[p.p0_full + j]
 *                     if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                         minval = tmpval
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "radiotool/algorithms/build_table_mem_efficient.pyx":298
 *                     tmpval = tc[orig_beat_i, p.p0 + j] + pen_val[idx] + cost[p.p0_full + j]
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval             # <<<<<<<<<<<<<<
 *                 min_vals[idx] = minval
 ...
 */
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":299
 *                     if minval == -1 or tmpval < minval:
 *                         minval = tmpval
 *                 min_vals[idx] = minval             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_31 < 0) {
          __pyx_t_37 = 0;
        } else if (unlikely(__pyx_t_31 >= __pyx_v_min_vals.shape[0])) __pyx_t_37 = 0;
        if (unlikely(__pyx_t_37 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_37);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 299; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_31 * __pyx_v_min_vals.strides[0]) )) = __pyx_v_minval;
      }

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":302
 * 
 *             # last pause beat
 *             minval = -1             # <<<<<<<<<<<<<<
 *             for j in range(p.n_beats):
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":303
 *             # last pause beat
 *             minval = -1
 *             for j in range(p.n_beats):             # <<<<<<<<<<<<<<
 *                 tmpval = tc[p.p0 + p.n_pauses - 1, j] + pen_val[p.all_full - 1] + cost[j]
 ...
 */
      ...
      for (__pyx_t_37 = 0; __pyx_t_37 < __pyx_t_15; __pyx_t_37+=1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":304
 *             minval = -1
 *             for j in range(p.n_beats):
 *                 tmpval = tc[p.p0 + p.n_pauses - 1, j] + pen_val[p.all_full - 1] + cost[j]             # <<<<<<<<<<<<<<
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval
 */
        __pyx_t_16 = ((__pyx_v_p.p0 + __pyx_v_p.n_pauses) - 1);
        __pyx_t_42 = __pyx_v_j;
        __pyx_t_43 = -1;
        if (__pyx_t_16 < 0) {
          __pyx_t_43 = 0;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_tc.shape[0])) __pyx_t_43 = 0;
        if (__pyx_t_42 < 0) {
          __pyx_t_43 = 1;
        } else if (unlikely(__pyx_t_42 >= __pyx_v_tc.shape[1])) __pyx_t_43 = 1;
        ...
        if (__pyx_t_44 < 0) {
          __pyx_t_43 = 0;
        } else if (unlikely(__pyx_t_44 >= __pyx_v_pen_val.shape[0])) __pyx_t_43 = 0;
        if (unlikely(__pyx_t_43 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_43);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 304; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        if (__pyx_t_43 < 0) {
          __pyx_t_45 = 0;
        } else if (unlikely(__pyx_t_43 >= __pyx_v_cost.shape[0])) __pyx_t_45 = 0;
        if (unlikely(__pyx_t_45 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_45);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 304; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_tmpval = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tc.data + __pyx_t_16 * __pyx_v_tc.strides[0]) ) + __pyx_t_42 * __pyx_v_tc.strides[1]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_pen_val.data + __pyx_t_44 * __pyx_v_pen_val.strides[0]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_43 * __pyx_v_cost.strides[0]) ))));

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":305
 *             for j in range(p.n_beats):
 *                 tmpval = tc[p.p0 + p.n_pauses - 1, j] + pen_val[p.all_full - 1] + cost[j]
 *                 if minval == -1 or tmpval < minval:             # <<<<<<<<<<<<<<
 *                     minval = tmpval
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "radiotool/algorithms/build_table_mem_efficient.pyx":306
 *                 tmpval = tc[p.p0 + p.n_pauses - 1, j] + pen_val[p.all_full - 1] + cost[j]
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval             # <<<<<<<<<<<<<<
 *             min_vals[p.all_full - 1] = minval
 ...
 */
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":307
 *                 if minval == -1 or tmpval < minval:
 *                     minval = tmpval
 *             min_vals[p.all_full - 1] = minval             # <<<<<<<<<<<<<<
 * 
 *         cost[:] = min_vals
 */
      __pyx_t_46 = (__pyx_v_p.all_full - 1);
      __pyx_t_15 = -1;
      if (__pyx_t_46 < 0) {
        __pyx_t_15 = 0;
      } else if (unlikely(__pyx_t_46 >= __pyx_v_min_vals.shape[0])) __pyx_t_15 = 0;
      if (unlikely(__pyx_t_15 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_15);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 307; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *((double *) ( /* dim=0 */ (__pyx_v_min_vals.data + __pyx_t_46 * __pyx_v_min_vals.strides[0]) )) = __pyx_v_minval;
    }
    __pyx_L6:;

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":309
 *             min_vals[p.all_full - 1] = minval
 * 
 *         cost[:] = min_vals             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_15 = -1;
    __pyx_t_47.data = __pyx_v_cost.data;
    __pyx_t_47.memview = __pyx_v_cost.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_47, 0);
    __pyx_t_47.shape[0] = __pyx_v_cost.shape[0];
__pyx_t_47.strides[0] = __pyx_v_cost.strides[0];
    __pyx_t_47.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_min_vals, __pyx_t_47, 1, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 309; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_47, 1);
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.backward_space_efficient_cost_with_duration_constraint", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "radiotool/algorithms/build_table_mem_efficient.pyx":312
 * 
 * 
...
static void __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__Pyx_memviewslice __pyx_v_tc, __Pyx_memviewslice __pyx_v_pen, int __pyx_v_start_beat, int __pyx_v_end_beat, int __pyx_v_offset, __Pyx_memviewslice __pyx_v_global_path, struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_mv1, __Pyx_memviewslice __pyx_v_mv2, __Pyx_memviewslice __pyx_v_mv3, __Pyx_memviewslice __pyx_v_mv4, __Pyx_memviewslice __pyx_v_mv5, __Pyx_memviewslice __pyx_v_mv6) {
  int __pyx_v_l;
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":318
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":321
 *     cdef double[:] new_pen, tc_column
 *     cdef int i, opt_i, l_over_2
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":323
 *     cdef double minval = -1.0
 * 
 *     if l == 0:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":325
 *     if l == 0:
 *         pass
 *     elif l == 1:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":327
 *     elif l == 1:
 *         pass
 *     elif l == 2 and start_beat != -1 and end_beat != -1:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":329
 *     elif l == 2 and start_beat != -1 and end_beat != -1:
 *         pass
 *     elif l == 2 and start_beat != -1:             # <<<<<<<<<<<<<<
 *         new_pen = mv1
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":330
 *         pass
 *     elif l == 2 and start_beat != -1:
 *         new_pen = mv1             # <<<<<<<<<<<<<<
 *         get_pen_column(pen, 1, new_pen, offset, p)
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":331
 *     elif l == 2 and start_beat != -1:
 *         new_pen = mv1
 *         get_pen_column(pen, 1, new_pen, offset, p)             # <<<<<<<<<<<<<<
 * 
 *         tc_column = mv2
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__pyx_v_pen, 1, __pyx_v_new_pen, __pyx_v_offset, __pyx_v_p);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":333
 *         get_pen_column(pen, 1, new_pen, offset, p)
 * 
 *         tc_column = mv2             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":334
 * 
 *         tc_column = mv2
 *         get_tc_column(tc, start_beat, tc_column, 1, p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__pyx_v_tc, __pyx_v_start_beat, __pyx_v_tc_column, 1, __pyx_v_p);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":336
 *         get_tc_column(tc, start_beat, tc_column, 1, p)
 * 
 *         global_path[offset] = start_beat             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_5 < 0) {
      __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_global_path.shape[0])) __pyx_t_6 = 0;
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_5 * __pyx_v_global_path.strides[0]) )) = __pyx_v_start_beat;
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":338
 *         global_path[offset] = start_beat
 * 
 *         minval = -1.0             # <<<<<<<<<<<<<<
 *         opt_i = 0
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":339
 * 
 *         minval = -1.0
 *         opt_i = 0             # <<<<<<<<<<<<<<
 *         for i in range(tc_column.shape[0]):
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":340
 *         minval = -1.0
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):             # <<<<<<<<<<<<<<
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 ...
 */
    __pyx_t_7 = (__pyx_v_tc_column.shape[0]);
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6+=1) {
      __pyx_v_i = __pyx_t_6;

      /* "radiotool/algorithms/build_table_mem_efficient.pyx":341
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:             # <<<<<<<<<<<<<<
 *                 minval = tc_column[i] + new_pen[i]
 ...
 */
      ...
      if (!__pyx_t_4) {
        ...
        if (__pyx_t_9 < 0) {
          __pyx_t_10 = 0;
        } else if (unlikely(__pyx_t_9 >= __pyx_v_new_pen.shape[0])) __pyx_t_10 = 0;
        if (unlikely(__pyx_t_10 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_10);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 341; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
      ...
      if (__pyx_t_1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":342
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 *                 minval = tc_column[i] + new_pen[i]             # <<<<<<<<<<<<<<
 *                 opt_i = i
 ...
 */
        ...
        if (__pyx_t_10 < 0) {
          __pyx_t_11 = 0;
        } else if (unlikely(__pyx_t_10 >= __pyx_v_tc_column.shape[0])) __pyx_t_11 = 0;
        if (unlikely(__pyx_t_11 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_11);
        ...
        if (__pyx_t_11 < 0) {
          __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_11 >= __pyx_v_new_pen.shape[0])) __pyx_t_12 = 0;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":343
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 *                 minval = tc_column[i] + new_pen[i]
 *                 opt_i = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":345
 *                 opt_i = i
 * 
 *         global_path[offset + 1] = opt_i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_13 = (__pyx_v_offset + 1);
    __pyx_t_6 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_global_path.shape[0])) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 345; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_13 * __pyx_v_global_path.strides[0]) )) = __pyx_v_opt_i;
    goto __pyx_L3;
  }

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":348
 * 
 *         # global_path_cost[offset + 1] = N.min(tc_column + new_pen)
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":349
 *         # global_path_cost[offset + 1] = N.min(tc_column + new_pen)
 *     elif l == 2 and end_beat != -1:
 *         new_pen = mv1             # <<<<<<<<<<<<<<
 *         get_pen_column(pen, 0, new_pen, offset, p)
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":350
 *     elif l == 2 and end_beat != -1:
 *         new_pen = mv1
 *         get_pen_column(pen, 0, new_pen, offset, p)             # <<<<<<<<<<<<<<
 * 
 *         tc_column = mv2
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_pen_column(__pyx_v_pen, 0, __pyx_v_new_pen, __pyx_v_offset, __pyx_v_p);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":352
 *         get_pen_column(pen, 0, new_pen, offset, p)
 * 
 *         tc_column = mv2             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":353
 * 
 *         tc_column = mv2
 *         get_tc_column(tc, end_beat, tc_column, 0, p)             # <<<<<<<<<<<<<<
 * 
 *         minval = -1.0
 */
    __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_get_tc_column(__pyx_v_tc, __pyx_v_end_beat, __pyx_v_tc_column, 0, __pyx_v_p);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":355
 *         get_tc_column(tc, end_beat, tc_column, 0, p)
 * 
 *         minval = -1.0             # <<<<<<<<<<<<<<
 *         opt_i = 0
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":356
 * 
 *         minval = -1.0
 *         opt_i = 0             # <<<<<<<<<<<<<<
 *         for i in range(tc_column.shape[0]):
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":357
 *         minval = -1.0
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):             # <<<<<<<<<<<<<<
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":358
 *         opt_i = 0
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:             # <<<<<<<<<<<<<<
 *                 minval = tc_column[i] + new_pen[i]
 ...
 */
      ...
      if (!__pyx_t_2) {
        ...
        if (__pyx_t_12 < 0) {
          __pyx_t_14 = 0;
        } else if (unlikely(__pyx_t_12 >= __pyx_v_tc_column.shape[0])) __pyx_t_14 = 0;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
        ...
        if (__pyx_t_14 < 0) {
          __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_14 >= __pyx_v_new_pen.shape[0])) __pyx_t_15 = 0;
        if (unlikely(__pyx_t_15 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_15);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 358; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_1 = ((((*((double *) ( /* dim=0 */ (__pyx_v_tc_column.data + __pyx_t_12 * __pyx_v_tc_column.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_new_pen.data + __pyx_t_14 * __pyx_v_new_pen.strides[0]) )))) < __pyx_v_minval) != 0);
        __pyx_t_4 = __pyx_t_1;
      } else {
        __pyx_t_4 = __pyx_t_2;
      }
      if (__pyx_t_4) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":359
 *         for i in range(tc_column.shape[0]):
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 *                 minval = tc_column[i] + new_pen[i]             # <<<<<<<<<<<<<<
 *                 opt_i = i
 ...
 */
        ...
        if (__pyx_t_16 < 0) {
          __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_new_pen.shape[0])) __pyx_t_17 = 0;
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":360
 *             if minval == -1.0 or tc_column[i] + new_pen[i] < minval:
 *                 minval = tc_column[i] + new_pen[i]
 *                 opt_i = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":362
 *                 opt_i = i
 * 
 *         global_path[offset] = opt_i             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_6 < 0) {
      __pyx_t_17 = 0;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_global_path.shape[0])) __pyx_t_17 = 0;
    if (unlikely(__pyx_t_17 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_17);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 362; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_6 * __pyx_v_global_path.strides[0]) )) = __pyx_v_opt_i;

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":363
 * 
 *         global_path[offset] = opt_i
 *         global_path[offset + 1] = end_beat             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_18 < 0) {
      __pyx_t_17 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_global_path.shape[0])) __pyx_t_17 = 0;
    if (unlikely(__pyx_t_17 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_17);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 363; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_18 * __pyx_v_global_path.strides[0]) )) = __pyx_v_end_beat;
    goto __pyx_L3;
  }

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":366
 * 
 *         # global_path_cost[offset] = N.min(tc_column + new_pen)
 *     elif l == 2:             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":372
 * 
 *     else:
 *         l_over_2 = l / 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":376
 *         # not sure why we need 8 of these arrays instead of 4
 ...
 */
    __pyx_t_17 = -1;
    __pyx_t_19.data = __pyx_v_pen.data;
    __pyx_t_19.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_19, 0);
    __pyx_t_19.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_19.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_19, __pyx_v_start_beat, -1, __pyx_v_offset, __pyx_v_p, __pyx_v_f, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":375
 * 
 *         # not sure why we need 8 of these arrays instead of 4
 *         space_efficient_cost_with_duration_constraint(             # <<<<<<<<<<<<<<
 *             tc, pen[:, :l_over_2 + 1], start_beat, -1, offset, p, f, mv1, mv2, mv3)
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":379
 * 
 *         backward_space_efficient_cost_with_duration_constraint(
...
__pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_backward_space_efficient_cost_with_duration_constraint(__pyx_v_tc, __pyx_t_20, -1, __pyx_v_end_beat, (__pyx_v_offset + __pyx_v_l_over_2), __pyx_v_p, __pyx_v_g, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":378
 *             tc, pen[:, :l_over_2 + 1], start_beat, -1, offset, p, f, mv1, mv2, mv3)
 * 
 *         backward_space_efficient_cost_with_duration_constraint(             # <<<<<<<<<<<<<<
 *             tc, pen[:, l_over_2:], -1, end_beat, offset + l_over_2, p, g, mv4, mv5, mv6)
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":381
 *             tc, pen[:, l_over_2:], -1, end_beat, offset + l_over_2, p, g, mv4, mv5, mv6)
 * 
 *         minval = -1.0             # <<<<<<<<<<<<<<
 *         opt_i = 0
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":382
 * 
 *         minval = -1.0
 *         opt_i = 0             # <<<<<<<<<<<<<<
 *         for i in range(f.shape[0]):
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":383
 *         minval = -1.0
 *         opt_i = 0
 *         for i in range(f.shape[0]):             # <<<<<<<<<<<<<<
 *             if minval == -1.0 or f[i] + g[i] < minval:
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_7; __pyx_t_17+=1) {
      ...
      /* "radiotool/algorithms/build_table_mem_efficient.pyx":384
 *         opt_i = 0
 *         for i in range(f.shape[0]):
 *             if minval == -1.0 or f[i] + g[i] < minval:             # <<<<<<<<<<<<<<
 *                 minval = f[i] + g[i]
 ...
 */
      ...
      if (!__pyx_t_4) {
        ...
        if (__pyx_t_21 < 0) {
          __pyx_t_22 = 0;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_f.shape[0])) __pyx_t_22 = 0;
        if (unlikely(__pyx_t_22 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_22);
        ...
        if (__pyx_t_22 < 0) {
          __pyx_t_23 = 0;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_g.shape[0])) __pyx_t_23 = 0;
        if (unlikely(__pyx_t_23 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_23);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 384; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_2 = ((((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_21 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_22 * __pyx_v_g.strides[0]) )))) < __pyx_v_minval) != 0);
        __pyx_t_1 = __pyx_t_2;
      } else {
        __pyx_t_1 = __pyx_t_4;
      }
      if (__pyx_t_1) {
        ...
        /* "radiotool/algorithms/build_table_mem_efficient.pyx":385
 *         for i in range(f.shape[0]):
 *             if minval == -1.0 or f[i] + g[i] < minval:
 *                 minval = f[i] + g[i]             # <<<<<<<<<<<<<<
 *                 opt_i = i
 ...
 */
        ...
        if (__pyx_t_23 < 0) {
          __pyx_t_24 = 0;
        } else if (unlikely(__pyx_t_23 >= __pyx_v_f.shape[0])) __pyx_t_24 = 0;
        if (unlikely(__pyx_t_24 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_24);
        ...
        if (__pyx_t_24 < 0) {
          __pyx_t_25 = 0;
        } else if (unlikely(__pyx_t_24 >= __pyx_v_g.shape[0])) __pyx_t_25 = 0;
        if (unlikely(__pyx_t_25 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_25);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 385; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_minval = ((*((double *) ( /* dim=0 */ (__pyx_v_f.data + __pyx_t_23 * __pyx_v_f.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_g.data + __pyx_t_24 * __pyx_v_g.strides[0]) ))));

        /* "radiotool/algorithms/build_table_mem_efficient.pyx":386
 *             if minval == -1.0 or f[i] + g[i] < minval:
 *                 minval = f[i] + g[i]
 *                 opt_i = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":388
 *                 opt_i = i
 * 
 *         global_path[l_over_2 + offset] = opt_i             # <<<<<<<<<<<<<<
 ...
 * 
 */
    __pyx_t_17 = (__pyx_v_l_over_2 + __pyx_v_offset);
    __pyx_t_25 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_25 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_global_path.shape[0])) __pyx_t_25 = 0;
    if (unlikely(__pyx_t_25 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_25);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 388; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *((int *) ( /* dim=0 */ (__pyx_v_global_path.data + __pyx_t_17 * __pyx_v_global_path.strides[0]) )) = __pyx_v_opt_i;

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":393
 *         # first half
 ...
 */
    __pyx_t_25 = -1;
    __pyx_t_26.data = __pyx_v_pen.data;
    __pyx_t_26.memview = __pyx_v_pen.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_26, 0);
    __pyx_t_26.shape[0] = __pyx_v_pen.shape[0];
__pyx_t_26.strides[0] = __pyx_v_pen.strides[0];
...
__pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_26, __pyx_v_start_beat, __pyx_v_opt_i, __pyx_v_offset, __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":392
 * 
 *         # first half
 *         divide_and_conquer_cost_and_path(             # <<<<<<<<<<<<<<
 *             tc, pen[:, :l_over_2 + 1], start_beat, opt_i, offset, global_path, p,
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":398
 *         # second half
 *         divide_and_conquer_cost_and_path(
...
__pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__pyx_v_tc, __pyx_t_27, __pyx_v_opt_i, __pyx_v_end_beat, (__pyx_v_l_over_2 + __pyx_v_offset), __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);

    /* "radiotool/algorithms/build_table_mem_efficient.pyx":397
 * 
 *         # second half
 *         divide_and_conquer_cost_and_path(             # <<<<<<<<<<<<<<
 *             tc, pen[:, l_over_2:], opt_i, end_beat, l_over_2 + offset, global_path, p,
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":401
 *             f, g, mv1, mv2, mv3, mv4, mv5, mv6)
 * 
 *     return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_26, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_27, 1);
  __Pyx_WriteUnraisable("radiotool.algorithms.build_table_mem_efficient.divide_and_conquer_cost_and_path", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
...
static PyObject *__pyx_pw_9radiotool_10algorithms_25build_table_mem_efficient_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_9radiotool_10algorithms_25build_table_mem_efficient_build_table *__pyx_optional_args) {
  int __pyx_v_min_beats = ((int)-1);
  int __pyx_v_max_beats = ((int)-1);
  int __pyx_v_first_pause = ((int)-1);
  int __pyx_v_max_beats_with_padding;
  struct __pyx_t_9radiotool_10algorithms_25build_table_mem_efficient_Params __pyx_v_p;
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":409
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":411
 *     if max_beats != -1 and min_beats != -1:
 *         # max_beats_with_padding = min_beats + max_beats
 *         max_beats_with_padding = max_beats             # <<<<<<<<<<<<<<
 *     elif max_beats != -1:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":412
 *         # max_beats_with_padding = min_beats + max_beats
 *         max_beats_with_padding = max_beats
 *     elif max_beats != -1:             # <<<<<<<<<<<<<<
 *         # 4? One measures of padding? Just a thought
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":414
 *     elif max_beats != -1:
 *         # 4? One measures of padding? Just a thought
 *         max_beats_with_padding = max_beats             # <<<<<<<<<<<<<<
 *     elif min_beats != -1:
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":415
 *         # 4? One measures of padding? Just a thought
 *         max_beats_with_padding = max_beats
 *     elif min_beats != -1:             # <<<<<<<<<<<<<<
 *         max_beats = -1
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":416
 *         max_beats_with_padding = max_beats
 *     elif min_beats != -1:
 *         max_beats = -1             # <<<<<<<<<<<<<<
 *         max_beats_with_padding = min_beats
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":417
 *     elif min_beats != -1:
 *         max_beats = -1
 *         max_beats_with_padding = min_beats             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":419
 *         max_beats_with_padding = min_beats
 *     else:
 *         max_beats_with_padding = 1             # <<<<<<<<<<<<<<
 *         max_beats = 1
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":420
 *     else:
 *         max_beats_with_padding = 1
 *         max_beats = 1             # <<<<<<<<<<<<<<
 *         min_beats = 0
 ...
 */
    ...
    /* "radiotool/algorithms/build_table_mem_efficient.pyx":421
 *         max_beats_with_padding = 1
 *         max_beats = 1
 *         min_beats = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":424
 * 
 *     cdef Params p
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":425
 *     cdef Params p
 *     p.pen_val = 99999999.0
 *     p.p0 = first_pause             # <<<<<<<<<<<<<<
 *     p.n_beats = p.p0
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":426
 *     p.pen_val = 99999999.0
 *     p.p0 = first_pause
 *     p.n_beats = p.p0             # <<<<<<<<<<<<<<
 *     p.n_pauses = trans_cost.shape[0] - p.p0
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":427
 *     p.p0 = first_pause
 *     p.n_beats = p.p0
 *     p.n_pauses = trans_cost.shape[0] - p.p0             # <<<<<<<<<<<<<<
 *     p.min_beats = min_beats
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":428
 *     p.n_beats = p.p0
 *     p.n_pauses = trans_cost.shape[0] - p.p0
 *     p.min_beats = min_beats             # <<<<<<<<<<<<<<
 *     p.max_beats = max_beats
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":429
 *     p.n_pauses = trans_cost.shape[0] - p.p0
 *     p.min_beats = min_beats
 *     p.max_beats = max_beats             # <<<<<<<<<<<<<<
 *     p.max_beats_with_padding = max_beats_with_padding
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":430
 *     p.min_beats = min_beats
 *     p.max_beats = max_beats
 *     p.max_beats_with_padding = max_beats_with_padding             # <<<<<<<<<<<<<<
 *     p.p0_full = p.n_beats * p.max_beats_with_padding
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":431
 *     p.max_beats = max_beats
 *     p.max_beats_with_padding = max_beats_with_padding
 *     p.p0_full = p.n_beats * p.max_beats_with_padding             # <<<<<<<<<<<<<<
 *     p.all_full = p.p0_full + p.n_pauses
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":432
 *     p.max_beats_with_padding = max_beats_with_padding
 *     p.p0_full = p.n_beats * p.max_beats_with_padding
 *     p.all_full = p.p0_full + p.n_pauses             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":435
 * 
 *     # double arrays for use throughout the computation
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 435; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_dtemplate = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":438
 *     cdef array array1, array2, array3, array4, array5, array6, array7, array8
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 438; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array1 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":439
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 *     array1 = clone(dtemplate, p.all_full, False)
 *     array2 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array3 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 439; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array2 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":440
 *     array1 = clone(dtemplate, p.all_full, False)
 *     array2 = clone(dtemplate, p.all_full, False)
 *     array3 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array4 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 440; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array3 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":441
 *     array2 = clone(dtemplate, p.all_full, False)
 *     array3 = clone(dtemplate, p.all_full, False)
 *     array4 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array5 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 441; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array4 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":442
 *     array3 = clone(dtemplate, p.all_full, False)
 *     array4 = clone(dtemplate, p.all_full, False)
 *     array5 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array6 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 442; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array5 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":443
 *     array4 = clone(dtemplate, p.all_full, False)
 *     array5 = clone(dtemplate, p.all_full, False)
 *     array6 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array7 = clone(dtemplate, p.all_full, False)
 ...
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array6 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":444
 *     array5 = clone(dtemplate, p.all_full, False)
 *     array6 = clone(dtemplate, p.all_full, False)
 *     array7 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     array8 = clone(dtemplate, p.all_full, False)
 *     f = array1
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array7 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":445
 *     array6 = clone(dtemplate, p.all_full, False)
 *     array7 = clone(dtemplate, p.all_full, False)
 *     array8 = clone(dtemplate, p.all_full, False)             # <<<<<<<<<<<<<<
 *     f = array1
 *     g = array2
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_dtemplate, __pyx_v_p.all_full, 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 445; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_array8 = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":446
 *     array7 = clone(dtemplate, p.all_full, False)
 *     array8 = clone(dtemplate, p.all_full, False)
 *     f = array1             # <<<<<<<<<<<<<<
 *     g = array2
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 446; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_f = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":447
 *     array8 = clone(dtemplate, p.all_full, False)
 *     f = array1
 *     g = array2             # <<<<<<<<<<<<<<
 *     mv1 = array3
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 447; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_g = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":448
 *     f = array1
 *     g = array2
 *     mv1 = array3             # <<<<<<<<<<<<<<
 *     mv2 = array4
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 448; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv1 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":449
 *     g = array2
 *     mv1 = array3
 *     mv2 = array4             # <<<<<<<<<<<<<<
 *     mv3 = array5
 ...
 */
  ...
  if (unlikely(!__pyx_t_6.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 449; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_mv2 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":450
 *     mv1 = array3
 *     mv2 = array4
 *     mv3 = array5             # <<<<<<<<<<<<<<
 *     mv4 = array6
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":451
 *     mv2 = array4
 *     mv3 = array5
 *     mv4 = array6             # <<<<<<<<<<<<<<
 *     mv5 = array7
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":452
 *     mv3 = array5
 *     mv4 = array6
 *     mv5 = array7             # <<<<<<<<<<<<<<
 *     mv6 = array8
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":453
 *     mv4 = array6
 *     mv5 = array7
 *     mv6 = array8             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":455
 *     mv6 = array8
 * 
 *     cdef array ar, template = array('i')             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_7cpython_5array_array)), __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 455; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_template = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":456
 * 
 *     cdef array ar, template = array('i')
 *     ar = clone(template, penalty.shape[1], False)             # <<<<<<<<<<<<<<
 *     cdef int[:] global_path = ar
 * 
 */
  __pyx_t_5 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template, (__pyx_v_penalty.shape[1]), 0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_ar = ((arrayobject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":457
 *     cdef array ar, template = array('i')
 *     ar = clone(template, penalty.shape[1], False)
 *     cdef int[:] global_path = ar             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_global_path = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":459
 *     cdef int[:] global_path = ar
 * 
 *     divide_and_conquer_cost_and_path(trans_cost, penalty, -1, -1, 0, global_path, p,             # <<<<<<<<<<<<<<
 *         f, g, mv1, mv2, mv3, mv4, mv5, mv6)
 * 
 */
  __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_divide_and_conquer_cost_and_path(__pyx_v_trans_cost, __pyx_v_penalty, -1, -1, 0, __pyx_v_global_path, __pyx_v_p, __pyx_v_f, __pyx_v_g, __pyx_v_mv1, __pyx_v_mv2, __pyx_v_mv3, __pyx_v_mv4, __pyx_v_mv5, __pyx_v_mv6);

  /* "radiotool/algorithms/build_table_mem_efficient.pyx":462
 *         f, g, mv1, mv2, mv3, mv4, mv5, mv6)
 * 
 *     return global_path             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("radiotool.algorithms.build_table_mem_efficient.build_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_9radiotool_10algorithms_25build_table_mem_efficient_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9radiotool_10algorithms_25build_table_mem_efficient_1build_table(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("build_table (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_penalty)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "build_table") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_trans_cost = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_trans_cost.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_penalty = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_penalty.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_min_beats = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_min_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_min_beats = ((int)-1);
    }
    if (values[3]) {
      __pyx_v_max_beats = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_max_beats == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_max_beats = ((int)-1);
    }
    if (values[4]) {
      __pyx_v_first_pause = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_first_pause == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("build_table", 0, 2, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("radiotool.algorithms.build_table_mem_efficient.build_table", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__pyx_self, __pyx_v_trans_cost, __pyx_v_penalty, __pyx_v_min_beats, __pyx_v_max_beats, __pyx_v_first_pause);
...
static PyObject *__pyx_pf_9radiotool_10algorithms_25build_table_mem_efficient_build_table(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_trans_cost, __Pyx_memviewslice __pyx_v_penalty, int __pyx_v_min_beats, int __pyx_v_max_beats, int __pyx_v_first_pause) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  struct __pyx_opt_args_9radiotool_10algorithms_25build_table_mem_efficient_build_table __pyx_t_2;
  ...
  if (unlikely(!__pyx_v_trans_cost.memview)) { __Pyx_RaiseUnboundLocalError("trans_cost"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_penalty.memview)) { __Pyx_RaiseUnboundLocalError("penalty"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_2.__pyx_n = 3;
  __pyx_t_2.min_beats = __pyx_v_min_beats;
  __pyx_t_2.max_beats = __pyx_v_max_beats;
  __pyx_t_2.first_pause = __pyx_v_first_pause;
  __pyx_t_1 = __pyx_f_9radiotool_10algorithms_25build_table_mem_efficient_build_table(__pyx_v_trans_cost, __pyx_v_penalty, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  __Pyx_NAMESTR("radiotool.algorithms.build_table_mem_efficient.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("radiotool.algorithms.build_table_mem_efficient.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("radiotool.algorithms.build_table_mem_efficient.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("radiotool.algorithms.build_table_mem_efficient._memoryviewslice"), /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("build_table"), (PyCFunction)__pyx_pw_9radiotool_10algorithms_25build_table_mem_efficient_1build_table, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("build_table_mem_efficient"),
    0, /* m_doc */
    -1, /* m_size */
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  #if PY_MAJOR_VERSION >= 3
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s_range); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 229; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #else
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s_xrange); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 229; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #endif
 ...
 *     cdef double[:] mv1, mv2, mv3, mv4, mv5, mv6, f, g
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_d); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 435; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef int[:] global_path = ar
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 455; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initbuild_table_mem_efficient(void); /*proto*/
PyMODINIT_FUNC initbuild_table_mem_efficient(void)
#else
PyMODINIT_FUNC PyInit_build_table_mem_efficient(void); /*proto*/
PyMODINIT_FUNC PyInit_build_table_mem_efficient(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_build_table_mem_efficient(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("build_table_mem_efficient"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_radiotool__algorithms__build_table_mem_efficient) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "radiotool.algorithms.build_table_mem_efficient")) {
      if (unlikely(PyDict_SetItemString(modules, "radiotool.algorithms.build_table_mem_efficient", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "radiotool/algorithms/build_table_mem_efficient.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init radiotool.algorithms.build_table_mem_efficient", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init radiotool.algorithms.build_table_mem_efficient");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
